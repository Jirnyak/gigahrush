...
- `README.md`
- `architecture.md`
- all files in `gatbage/reference/ux_rework/rework_*.md`
- `git status --short`
...
git status --short
git diff --stat
git diff -- src tests gatbage/reference/ux_rework README.md package.json scripts
```
...
Do not create agent-log or task-status directories. Keep durable campaign context in `gatbage/reference/ux_rework/` or active planning docs.
