...
Existing generator references: `src/gen/void/`, `gatbage/reference/expansions/10_void_afterprotocol/`. Planning sections below describe possible route-scale expansion, not shipped design-floor route data.
