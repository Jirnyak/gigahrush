...
Owned file: `src/gen/design_floors/dark_metro.ts`. Existing references: `gatbage/reference/expansions/02_metro_error_line/`, `src/gen/maintenance/metro_error_line.ts`. Planning sections below may predate the routed train implementation; verify exact train behavior against source.
