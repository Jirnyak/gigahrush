...
Owned file: `src/gen/design_floors/raionsovet_archive.ts`. Existing design reference: `gatbage/reference/expansions/03_raionsovet_archive/`. Planning sections below preserve the older `Живой архив` name and may predate the routed implementation.
