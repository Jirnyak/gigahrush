...
Authority: `gatbage/reference/expansions/03_raionsovet_archive/expansion.md`, `README.md`, `desdoc.md`, `gatbage/reference/expansions/INDEX.md`
...
Critical document/access/archive code must keep the last 300 high-level decisions in a fixed-size circular buffer. In MVP TypeScript this can begin as a bounded numeric array. On NaN, impossible `expiresAtHour`, invalid missing def, or unknown result code, the future runtime must dump to `gatbage/history/agent_logs/Dump_EXP03_RAIONSOVET.bin`.
