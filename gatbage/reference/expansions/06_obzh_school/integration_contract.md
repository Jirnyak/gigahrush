...
On impossible state or NaN, dump buffer to `gatbage/history/agent_logs/Dump_EXP06_SCHOOL.bin`. The dump must be binary or compact JSON written once per fault, not spammed every tick.
