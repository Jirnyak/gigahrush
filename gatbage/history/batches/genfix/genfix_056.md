# genfix_056: говнячный смог: жилая нарезка, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/056_z-5_procedural_z-5_говнячный_смог_жилая_нарезка,_гражданский_этаж.png`
- Route: procedural `z-5`, z-5, index 056/101
- Procedural profile: geometry `living_blocks`, anomaly `smog`, majority `citizens`, danger 2
- Current metrics: rooms 98, doors 122, containers 17, entities 1023, reachable 25094, walls 1023466, floors 25110
...
```text
056_z-5_procedural_z-5_говнячный_смог_жилая_нарезка,_гражданский_этаж.png
интересно но этаж нужно заполнить
```

## Diagnosis

- Главная проблема: генератор останавливается слишком рано и оставляет внешний/межкоридорный объем без структуры.
- Процедурный профиль: geometry=living_blocks, anomaly=smog, majority=citizens, danger=2. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 056 --out-dir tmp/floor-maps/genfix_056_after`
