# genfix_075: Шахта-атриум

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/075_z-24_design_shahta_atrium_Шахта-атриум.png`
- Route: design `shahta_atrium`, z-24, index 075/101
- Design route id: `shahta_atrium`, role: вертикальный провал, мосты, сервисный обод, danger 4
- Current metrics: rooms 18, doors 4, containers 3, entities 2722, reachable 102144, walls 909511, floors 102148
...
- Target control shares: граждане 14%, ликвидаторы 44%, культисты 10%, учёные 10%, дикие 22%.
...
```text
075_z-24_design_shahta_atrium_Шахта-атриум.png
ОЧЕНЬ ХОРОШЕЕ МАКРО
Интресно и оригинально
но надо добавлять микросткрутуры между макро и возможно больше внешних колец вокруг а то пусто по краям
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 14%, ликвидаторы 44%, культисты 10%, учёные 10%, дикие 22%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 075 --out-dir tmp/floor-maps/genfix_075_after`
...
- `./node_modules/.bin/tsx --test tests/shahta-atrium.test.ts`
- `npm run typecheck`
