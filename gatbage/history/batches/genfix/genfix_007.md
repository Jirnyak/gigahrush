# genfix_007: Радоновый обменник

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/007_z+44_design_radon_exchange_Радоновый_обменник.png`
- Route: design `radon_exchange`, z+44, index 007/101
- Design route id: `radon_exchange`, role: скан-линии, заслонки, проекционный ключ, danger 4
- Current metrics: rooms 9, doors 26, containers 2, entities 3848, reachable 72292, walls 976282, floors 72294
...
- Target control shares: граждане 16%, ликвидаторы 36%, культисты 10%, учёные 26%, дикие 12%.
...
```text
007_z+44_design_radon_exchange_Радоновый_обменник.png
макроструктура интересная
но нарушены масштабы что нет никаких комнат локальных и маленьких структур надо добавить
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 16%, ликвидаторы 36%, культисты 10%, учёные 26%, дикие 12%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 007 --out-dir tmp/floor-maps/genfix_007_after`
...
- `./node_modules/.bin/tsx --test tests/radon-exchange.test.ts`
- `npm run typecheck`
