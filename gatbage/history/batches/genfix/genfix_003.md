# genfix_003: живые тоннели: чердачные венткамеры, дикий этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/003_z+48_procedural_z48_живые_тоннели_чердачные_венткамеры,_дикий_этаж.png`
- Route: procedural `z48`, z+48, index 003/101
- Procedural profile: geometry `attic_weatherworks`, anomaly `living_tunnels`, majority `wild`, danger 5
- Current metrics: rooms 96, doors 240, containers 24, entities 2269, reachable 64944, walls 983616, floors 64960
...
```text
003_z+48_procedural_z48_живые_тоннели_чердачные_венткамеры,_дикий_этаж
...
- Процедурный профиль: geometry=attic_weatherworks, anomaly=living_tunnels, majority=wild, danger=5. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `src/gen/procedural_anomalies/living_tunnels.ts`
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 003 --out-dir tmp/floor-maps/genfix_003_after`
