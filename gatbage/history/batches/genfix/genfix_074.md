# genfix_074: сервисные штреки, этаж ликвидаторов

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/074_z-23_procedural_z-23_сервисные_штреки,_этаж_ликвидаторов.png`
- Route: procedural `z-23`, z-23, index 074/101
- Procedural profile: geometry `service_spines`, anomaly `none`, majority `liquidators`, danger 3
- Current metrics: rooms 84, doors 188, containers 16, entities 1433, reachable 113872, walls 934688, floors 113888
...
```text
074_z-23_procedural_z-23_сервисные_штреки,_этаж_ликвидаторов.png
плохо
```
...
- Процедурный профиль: geometry=service_spines, anomaly=none, majority=liquidators, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 074 --out-dir tmp/floor-maps/genfix_074_after`
