# genfix_052: жилая нарезка, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/052_z-1_procedural_z-1_жилая_нарезка,_научная_смена.png`
- Route: procedural `z-1`, z-1, index 052/101
- Procedural profile: geometry `living_blocks`, anomaly `none`, majority `scientists`, danger 2
- Current metrics: rooms 98, doors 88, containers 12, entities 900, reachable 24467, walls 1024093, floors 24483
...
```text
052_z-1_procedural_z-1_жилая_нарезка,_научная_смена.png
интересно но алгоритм не доделан нужно заполнять весь этаж
```

## Diagnosis

- Главная проблема: генератор останавливается слишком рано и оставляет внешний/межкоридорный объем без структуры.
- Процедурный профиль: geometry=living_blocks, anomaly=none, majority=scientists, danger=2. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 052 --out-dir tmp/floor-maps/genfix_052_after`
