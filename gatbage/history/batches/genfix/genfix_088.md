# genfix_088: зеркальная проводка: коллекторы, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/088_z-37_procedural_z-37_зеркальная_проводка_коллекторы,_гражданский_этаж.png`
- Route: procedural `z-37`, z-37, index 088/101
- Procedural profile: geometry `collectors`, anomaly `mirror_run`, majority `citizens`, danger 4
- Current metrics: rooms 96, doors 233, containers 38, entities 1848, reachable 201710, walls 846850, floors 201726
...
```text
088_z-37_procedural_z-37_зеркальная_проводка_коллекторы,_гражданский_этаж.png
плохо
```
...
- Процедурный профиль: geometry=collectors, anomaly=mirror_run, majority=citizens, danger=4. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 088 --out-dir tmp/floor-maps/genfix_088_after`
