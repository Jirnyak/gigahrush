# genfix_033: Морг регистраций

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/033_z+18_design_registry_morgue_Морг_регистраций.png`
- Route: design `registry_morgue`, z+18, index 033/101
- Design route id: `registry_morgue`, role: мертвые записи и проверки, danger 4
- Current metrics: rooms 73, doors 64, containers 47, entities 1639, reachable 137545, walls 911029, floors 137547
...
- Target control shares: граждане 28%, ликвидаторы 34%, культисты 12%, учёные 18%, дикие 8%.
...
```text
033_z+18_design_registry_morgue_Морг_регистраций.png
ИНТЕРЕСНОЕ МАКРО
хорошо 
но масштабы не учтены надо добавлять микро комнаты 
много пустого
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 28%, ликвидаторы 34%, культисты 12%, учёные 18%, дикие 8%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 033 --out-dir tmp/floor-maps/genfix_033_after`
...
- `./node_modules/.bin/tsx --test tests/registry-morgue.test.ts`
- `npm run typecheck`
