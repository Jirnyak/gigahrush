# genfix_090: говнячный смог: коллекторы, этаж ликвидаторов

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/090_z-39_procedural_z-39_говнячный_смог_коллекторы,_этаж_ликвидаторов.png`
- Route: procedural `z-39`, z-39, index 090/101
- Procedural profile: geometry `collectors`, anomaly `smog`, majority `liquidators`, danger 4
- Current metrics: rooms 96, doors 201, containers 30, entities 1959, reachable 221030, walls 827530, floors 221046
...
```text
090_z-39_procedural_z-39_говнячный_смог_коллекторы,_этаж_ликвидаторов.png
плохо
```
...
- Процедурный профиль: geometry=collectors, anomaly=smog, majority=liquidators, danger=4. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 090 --out-dir tmp/floor-maps/genfix_090_after`
