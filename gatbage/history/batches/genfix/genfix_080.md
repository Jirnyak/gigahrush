# genfix_080: сортировочный конвейер: сервисные штреки, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/080_z-29_procedural_z-29_сортировочный_конвейер_сервисные_штреки,_научная_смена.png`
- Route: procedural `z-29`, z-29, index 080/101
- Procedural profile: geometry `service_spines`, anomaly `conveyor_sorter`, majority `scientists`, danger 4
- Current metrics: rooms 91, doors 188, containers 22, entities 1850, reachable 116142, walls 932418, floors 116158
...
```text
080_z-29_procedural_z-29_сортировочный_конвейер_сервисные_штреки,_научная_смена.png
плохо
```
...
- Процедурный профиль: geometry=service_spines, anomaly=conveyor_sorter, majority=scientists, danger=4. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 080 --out-dir tmp/floor-maps/genfix_080_after`
