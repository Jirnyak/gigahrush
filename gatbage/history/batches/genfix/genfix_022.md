# genfix_022: архивные норы, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/022_z+29_procedural_z29_архивные_норы,_гражданский_этаж.png`
- Route: procedural `z29`, z+29, index 022/101
- Procedural profile: geometry `archive_warrens`, anomaly `none`, majority `citizens`, danger 2
- Current metrics: rooms 225, doors 560, containers 18, entities 1259, reachable 51740, walls 996820, floors 51756
...
```text
022_z+29_procedural_z29_архивные_норы,_гражданский_этаж.png
макро хорошее но надо добавлять очень много микрокомнат
пока это пустые коридоры с хорошей макроструктурой
```
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 022 --out-dir tmp/floor-maps/genfix_022_after`
