# genfix_023: Истинный лабиринт

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/023_z+28_design_istinniy_labirint_Истинный_лабиринт.png`
- Route: design `istinniy_labirint`, z+28, index 023/101
- Design route id: `istinniy_labirint`, role: путь, метки, отступление, danger 4
- Current metrics: rooms 7, doors 9, containers 8, entities 2202, reachable 247256, walls 801318, floors 247258
...
- Target control shares: граждане 24%, ликвидаторы 16%, культисты 16%, учёные 10%, дикие 34%.
...
```text
023_z+28_design_istinniy_labirint_Истинный_лабиринт.png
хорошо 
возможно убрать длинные коридоры аномальные которые сливаются со структурой
```
...
- `tests/istinniy-labirint.test.ts`
- `factions.md`
...
- Faction control starts from HQs and approximately matches target shares: граждане 24%, ликвидаторы 16%, культисты 16%, учёные 10%, дикие 34%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 023 --out-dir tmp/floor-maps/genfix_023_after`
...
- `./node_modules/.bin/tsx --test tests/istinniy-labirint.test.ts`
- `npm run typecheck`
