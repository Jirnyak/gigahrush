# genfix_017: Верхнее бюро

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/017_z+34_design_upper_bureau_Верхнее_бюро.png`
- Route: design `upper_bureau`, z+34, index 017/101
- Design route id: `upper_bureau`, role: документы и доступ, danger 3
- Current metrics: rooms 50, doors 70, containers 7, entities 1763, reachable 121091, walls 927483, floors 121093
...
- Target control shares: граждане 42%, ликвидаторы 26%, культисты 8%, учёные 16%, дикие 8%.
...
```text
ч017_z+34_design_upper_bureau_Верхнее_бюро.png
нарушены масштабы потенциально интересно но нужно добавить маленьких комнат
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 42%, ликвидаторы 26%, культисты 8%, учёные 16%, дикие 8%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 017 --out-dir tmp/floor-maps/genfix_017_after`
