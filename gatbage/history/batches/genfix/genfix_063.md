# genfix_063: сервисные штреки, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/063_z-12_procedural_z-12_сервисные_штреки,_научная_смена.png`
- Route: procedural `z-12`, z-12, index 063/101
- Procedural profile: geometry `service_spines`, anomaly `none`, majority `scientists`, danger 2
- Current metrics: rooms 78, doors 185, containers 12, entities 970, reachable 106017, walls 942543, floors 106033
...
```text
063_z-12_procedural_z-12_сервисные_штреки,_научная_смена.png
алгоритм недоделан
непонятно и пусто
скорее плохо но может если доделать то станет норм
```
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 063 --out-dir tmp/floor-maps/genfix_063_after`
