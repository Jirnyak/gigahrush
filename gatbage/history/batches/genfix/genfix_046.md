# genfix_046: цементная память: плотные квартиры, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/046_z+5_procedural_z5_цементная_память_плотные_квартиры,_гражданский_этаж.png`
- Route: procedural `z5`, z+5, index 046/101
- Procedural profile: geometry `apartment_pressure`, anomaly `cement_memory`, majority `citizens`, danger 3
- Current metrics: rooms 122, doors 333, containers 19, entities 1310, reachable 35509, walls 1013051, floors 35525
...
```text
046_z+5_procedural_z5_цементная_память_плотные_квартиры,_гражданский_этаж.png
плохо
```
...
- Процедурный профиль: geometry=apartment_pressure, anomaly=cement_memory, majority=citizens, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `src/gen/procedural_anomalies/cement_memory.ts`
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 046 --out-dir tmp/floor-maps/genfix_046_after`
