...
- Map: `tmp/floor-maps/all_route_seed_61061/091_z-40_design_podad_Подад.png`
- Route: design `podad`, z-40, index 091/101
- Design route id: `podad`, role: живые тоннели, двигающиеся стены, нижний порог, danger 5
- Current metrics: rooms 7, doors 19, containers 0, entities 4099, reachable 247971, walls 800600, floors 247976
...
- Target control shares: граждане 6%, ликвидаторы 9%, культисты 38%, учёные 5%, дикие 28%, самосбор 14%.
...
```text
091_z-40_design_podad_Подад.png
вроде норм по крайней мере видна оригинальность но надо доделать и тогда будет хорошо
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 6%, ликвидаторы 9%, культисты 38%, учёные 5%, дикие 28%, самосбор 14%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 091 --out-dir tmp/floor-maps/genfix_091_after`
