# genfix_079: Гармоническая баня

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/079_z-28_design_harmonic_bathhouse_Гармоническая_баня.png`
- Route: design `harmonic_bathhouse`, z-28, index 079/101
- Design route id: `harmonic_bathhouse`, role: пар, давление, горячий и холодный обход, danger 4
- Current metrics: rooms 26, doors 61, containers 4, entities 2660, reachable 124672, walls 923902, floors 124674
...
- Target control shares: граждане 24%, ликвидаторы 38%, культисты 10%, учёные 14%, дикие 14%.
...
```text
079_z-28_design_harmonic_bathhouse_Гармоническая_баня.png
чтото интересное виднее в центр
но недоделно
нужно заполнять вокруг тоже и доделывать 
но потенциал хороший
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 24%, ликвидаторы 38%, культисты 10%, учёные 14%, дикие 14%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 079 --out-dir tmp/floor-maps/genfix_079_after`
...
- `./node_modules/.bin/tsx --test tests/harmonic-bathhouse.test.ts`
- `npm run typecheck`
