# genfix_089: Нижний пропускник

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/089_z-38_design_underhell_Нижний_пропускник.png`
- Route: design `underhell`, z-38, index 089/101
- Design route id: `underhell`, role: боевой порог мясного низа, danger 5
- Current metrics: rooms 29, doors 6, containers 1, entities 4107, reachable 112066, walls 35363, floors 112067
...
- Target control shares: граждане 7%, ликвидаторы 10%, культисты 38%, учёные 5%, дикие 28%, самосбор 12%.
...
```text
089_z-38_design_underhell_Нижний_пропускник.png
неплохо 
есть потенциаль
интересно но масштабы не учтены много очень пустого надо между большие промежутки без структур тоже заполнить чемто
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 7%, ликвидаторы 10%, культисты 38%, учёные 5%, дикие 28%, самосбор 12%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 089 --out-dir tmp/floor-maps/genfix_089_after`
...
- `./node_modules/.bin/tsx --test tests/underhell.test.ts`
- `npm run typecheck`
