# genfix_092: поезда: затопленные эстакады, дикий этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/092_z-41_procedural_z-41_поезда_затопленные_эстакады,_дикий_этаж.png`
- Route: procedural `z-41`, z-41, index 092/101
- Procedural profile: geometry `sump_causeways`, anomaly `rail_trains`, majority `wild`, danger 5
- Current metrics: rooms 95, doors 208, containers 22, entities 2242, reachable 78599, walls 969961, floors 78615
...
```text
092_z-41_procedural_z-41_поезда_затопленные_эстакады,_дикий_этаж.png
плохо
```
...
- Процедурный профиль: geometry=sump_causeways, anomaly=rail_trains, majority=wild, danger=5. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 092 --out-dir tmp/floor-maps/genfix_092_after`
