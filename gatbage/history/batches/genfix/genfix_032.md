# genfix_032: зеркальная проводка: административные карманы, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/032_z+19_procedural_z19_зеркальная_проводка_административные_карманы,_гражданский_этаж.png`
- Route: procedural `z19`, z+19, index 032/101
- Procedural profile: geometry `admin_pockets`, anomaly `mirror_run`, majority `citizens`, danger 3
- Current metrics: rooms 88, doors 231, containers 36, entities 1358, reachable 54078, walls 994482, floors 54094
...
```text
032_z+19_procedural_z19_зеркальная_проводка_административные_карманы,_гражданский_этаж.png
плохо
```
...
- Процедурный профиль: geometry=admin_pockets, anomaly=mirror_run, majority=citizens, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 032 --out-dir tmp/floor-maps/genfix_032_after`
