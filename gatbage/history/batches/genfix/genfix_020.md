# genfix_020: административные карманы, дикий этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/020_z+31_procedural_z31_административные_карманы,_дикий_этаж.png`
- Route: procedural `z31`, z+31, index 020/101
- Procedural profile: geometry `admin_pockets`, anomaly `none`, majority `wild`, danger 3
- Current metrics: rooms 91, doors 223, containers 19, entities 1522, reachable 50242, walls 998318, floors 50258
...
```text
020_z+31_procedural_z31_административные_карманы,_дикий_этаж.png
плохо аналогично пустые коридоры
```
...
- Процедурный профиль: geometry=admin_pockets, anomaly=none, majority=wild, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 020 --out-dir tmp/floor-maps/genfix_020_after`
