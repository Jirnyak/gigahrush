# genfix_038: плотные квартиры, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/038_z+13_procedural_z13_плотные_квартиры,_гражданский_этаж.png`
- Route: procedural `z13`, z+13, index 038/101
- Procedural profile: geometry `apartment_pressure`, anomaly `none`, majority `citizens`, danger 2
- Current metrics: rooms 116, doors 311, containers 12, entities 1100, reachable 37371, walls 1011050, floors 37526
...
```text
038_z+13_procedural_z13_плотные_квартиры,_гражданский_этаж.png
плохо
```
...
- Процедурный профиль: geometry=apartment_pressure, anomaly=none, majority=citizens, danger=2. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 038 --out-dir tmp/floor-maps/genfix_038_after`
