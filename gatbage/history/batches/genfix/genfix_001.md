...
- Map: `tmp/floor-maps/all_route_seed_61061/001_z+50_design_roof_Крыша.png`
- Route: design `roof`, z+50, index 001/101
- Design route id: `roof`, role: воздух, антенны, видимость, danger 2
- Current metrics: rooms 34, doors 41, containers 5, entities 4100, reachable 80567, walls 32603, floors 82318
...
- Target control shares: граждане 28%, ликвидаторы 38%, культисты 8%, учёные 14%, дикие 12%.
...
```text
001_z+50_design_roof_Крыша.png
НАРУШЕНЫ МАСШТАБЫ
очень пусто
есть несколько больших комнат но это неиграбельно длинные коридоры и всё
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 28%, ликвидаторы 38%, культисты 8%, учёные 14%, дикие 12%.
