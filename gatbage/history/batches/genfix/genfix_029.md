# genfix_029: Райсовет и архив картотек

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/029_z+22_design_raionsovet_archive_Райсовет_и_архив_картотек.png`
- Route: design `raionsovet_archive`, z+22, index 029/101
- Design route id: `raionsovet_archive`, role: архивы, картотеки, пропуска, danger 3
- Current metrics: rooms 28, doors 60, containers 7, entities 2028, reachable 393226, walls 646326, floors 393658
...
- Target control shares: граждане 44%, ликвидаторы 22%, культисты 8%, учёные 14%, дикие 12%.
...
```text
029_z+22_design_raionsovet_archive_Райсовет_и_архив_картотек.png
интересное макро
очень необычное и это хорошо
но надо добавить микрокомнат
```
...
- `tests/raionsovet-archive.test.ts`
- `factions.md`
...
- Faction control starts from HQs and approximately matches target shares: граждане 44%, ликвидаторы 22%, культисты 8%, учёные 14%, дикие 12%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 029 --out-dir tmp/floor-maps/genfix_029_after`
...
- `./node_modules/.bin/tsx --test tests/raionsovet-archive.test.ts`
- `npm run typecheck`
