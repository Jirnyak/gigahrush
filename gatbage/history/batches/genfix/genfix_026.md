# genfix_026: тихий блок: архивные норы, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/026_z+25_procedural_z25_тихий_блок_архивные_норы,_гражданский_этаж.png`
- Route: procedural `z25`, z+25, index 026/101
- Procedural profile: geometry `archive_warrens`, anomaly `false_safe_block`, majority `citizens`, danger 3
- Current metrics: rooms 225, doors 574, containers 33, entities 1523, reachable 52427, walls 996133, floors 52443
...
- Target control shares: граждане 53%, ликвидаторы 16%, культисты 12%, учёные 8%, дикие 11%.
- Dominant owner: граждане; reason: procedural majority citizens plus false-safe cult foothold.
...
```text
026_z+25_procedural_z25_тихий_блок_архивные_норы,_гражданский_этаж.png
интересное макро но пусто нет комнат
```
...
- Процедурный профиль: geometry=archive_warrens, anomaly=false_safe_block, majority=citizens, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- Faction control starts from HQs and approximately matches target shares: граждане 53%, ликвидаторы 16%, культисты 12%, учёные 8%, дикие 11%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 026 --out-dir tmp/floor-maps/genfix_026_after`
