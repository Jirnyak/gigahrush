# genfix_100: затопленные эстакады, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/100_z-49_procedural_z-49_затопленные_эстакады,_научная_смена.png`
- Route: procedural `z-49`, z-49, index 100/101
- Procedural profile: geometry `sump_causeways`, anomaly `none`, majority `scientists`, danger 4
- Current metrics: rooms 85, doors 195, containers 18, entities 766, reachable 61522, walls 987038, floors 61538
...
```text
100_z-49_procedural_z-49_затопленные_эстакады,_научная_смена.png
плохо
```
...
- Процедурный профиль: geometry=sump_causeways, anomaly=none, majority=scientists, danger=4. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 100 --out-dir tmp/floor-maps/genfix_100_after`
