# genfix_025: Банковский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/025_z+26_design_bank_floor_Банковский_этаж.png`
- Route: design `bank_floor`, z+26, index 025/101
- Design route id: `bank_floor`, role: деньги, долги, сейфы, danger 3
- Current metrics: rooms 39, doors 43, containers 9, entities 2055, reachable 128966, walls 919608, floors 128968
...
- Target control shares: граждане 42%, ликвидаторы 28%, культисты 8%, учёные 10%, дикие 12%.
...
```text
025_z+26_design_bank_floor_Банковский_этаж.png
интересное макро но нужно добавить микро - кабинеты переходы склады и тд
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 42%, ликвидаторы 28%, культисты 8%, учёные 10%, дикие 12%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 025 --out-dir tmp/floor-maps/genfix_025_after`
...
- `./node_modules/.bin/tsx --test tests/bank-floor.test.ts`
- `npm run typecheck`
