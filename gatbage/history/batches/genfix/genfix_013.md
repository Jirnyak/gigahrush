# genfix_013: Пионерлагерь

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/013_z+38_design_pioneer_camp_Пионерлагерь.png`
- Route: design `pioneer_camp`, z+38, index 013/101
- Design route id: `pioneer_camp`, role: социальный лагерь, детские запасы, danger 2
- Current metrics: rooms 38, doors 26, containers 6, entities 2009, reachable 79585, walls 968989, floors 79587
...
- Target control shares: граждане 58%, ликвидаторы 12%, культисты 7%, учёные 9%, дикие 14%.
...
```text
013_z+38_design_pioneer_camp_Пионерлагерь.png
интересная макроструктура но надо добавить маленьих комнат и больше разнообразия внутри мароструктуры
можно добавить ещё крупных пустых зон типа дворы/парки/леса
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 58%, ликвидаторы 12%, культисты 7%, учёные 9%, дикие 14%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 013 --out-dir tmp/floor-maps/genfix_013_after`
