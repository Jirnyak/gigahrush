# genfix_061: Черный рынок 88

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/061_z-10_design_black_market_88_Черный_рынок_88.png`
- Route: design `black_market_88`, z-10, index 061/101
- Design route id: `black_market_88`, role: торговля, контрабанда, долги, danger 3
- Current metrics: rooms 171, doors 198, containers 14, entities 2906, reachable 107053, walls 941520, floors 107056
...
- Target control shares: граждане 16%, ликвидаторы 9%, культисты 8%, учёные 7%, дикие 60%.
...
```text
061_z-10_design_black_market_88_Черный_рынок_88.png
интересно но много пустого пространства
основа хорошая надо просто развить и добавить ещё ращнообразия и заполнения
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 16%, ликвидаторы 9%, культисты 8%, учёные 7%, дикие 60%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 061 --out-dir tmp/floor-maps/genfix_061_after`
