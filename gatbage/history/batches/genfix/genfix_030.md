# genfix_030: сортировочный конвейер: административные карманы, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/030_z+21_procedural_z21_сортировочный_конвейер_административные_карманы,_научная_смена.png`
- Route: procedural `z21`, z+21, index 030/101
- Procedural profile: geometry `admin_pockets`, anomaly `conveyor_sorter`, majority `scientists`, danger 3
- Current metrics: rooms 88, doors 194, containers 23, entities 1358, reachable 52658, walls 995902, floors 52674
...
```text
030_z+21_procedural_z21_сортировочный_конвейер_административные_карманы,_научная_смена.png
плохо 
пустые коридоры
```
...
- Процедурный профиль: geometry=admin_pockets, anomaly=conveyor_sorter, majority=scientists, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 030 --out-dir tmp/floor-maps/genfix_030_after`
