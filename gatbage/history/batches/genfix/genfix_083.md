# genfix_083: Темная пересадка

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/083_z-32_design_dark_metro_Темная_пересадка.png`
- Route: design `dark_metro`, z-32, index 083/101
- Design route id: `dark_metro`, role: опасный короткий ход, danger 4
- Current metrics: rooms 75, doors 42, containers 15, entities 3669, reachable 213556, walls 835018, floors 213558
...
- Target control shares: граждане 14%, ликвидаторы 24%, культисты 14%, учёные 8%, дикие 40%.
...
```text
083_z-32_design_dark_metro_Темная_пересадка.png
хорошо но тоже не доделано надо доделать потенциал хороший
но масштабы похоже нарушены
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 14%, ликвидаторы 24%, культисты 14%, учёные 8%, дикие 40%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 083 --out-dir tmp/floor-maps/genfix_083_after`
