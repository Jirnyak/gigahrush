# genfix_042: плотные квартиры, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/042_z+9_procedural_z9_плотные_квартиры,_гражданский_этаж.png`
- Route: procedural `z9`, z+9, index 042/101
- Procedural profile: geometry `apartment_pressure`, anomaly `none`, majority `citizens`, danger 3
- Current metrics: rooms 122, doors 320, containers 14, entities 1159, reachable 40151, walls 1008409, floors 40167
...
```text
042_z+9_procedural_z9_плотные_квартиры,_гражданский_этаж.png
плохо
```
...
- Процедурный профиль: geometry=apartment_pressure, anomaly=none, majority=citizens, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 042 --out-dir tmp/floor-maps/genfix_042_after`
