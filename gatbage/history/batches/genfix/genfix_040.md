# genfix_040: коммунальные узлы, этаж ликвидаторов

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/040_z+11_procedural_z11_коммунальные_узлы,_этаж_ликвидаторов.png`
- Route: procedural `z11`, z+11, index 040/101
- Procedural profile: geometry `communal_knots`, anomaly `none`, majority `liquidators`, danger 2
- Current metrics: rooms 124, doors 287, containers 17, entities 904, reachable 163901, walls 884659, floors 163917
...
```text
040_z+11_procedural_z11_коммунальные_узлы,_этаж_ликвидаторов.png
ХОРОШАЯ видно что интересный этаж
хорошо!
```
...
- Процедурный профиль: geometry=communal_knots, anomaly=none, majority=liquidators, danger=2. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 040 --out-dir tmp/floor-maps/genfix_040_after`
