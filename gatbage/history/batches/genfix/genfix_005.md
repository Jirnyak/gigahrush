# genfix_005: Чердак техслужб

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/005_z+46_design_chthonic_attic_Чердак_техслужб.png`
- Route: design `chthonic_attic`, z+46, index 005/101
- Design route id: `chthonic_attic`, role: техчердак, тайники, старые шахты, danger 3
- Current metrics: rooms 32, doors 17, containers 16, entities 2906, reachable 34607, walls 1011536, floors 34650
...
- Target control shares: граждане 18%, ликвидаторы 24%, культисты 14%, учёные 10%, дикие 34%.
...
```text
005_z+46_design_chthonic_attic_Чердак_техслужб.png

интересно но очень мало сткруттур большая часть карты пустая
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 18%, ликвидаторы 24%, культисты 14%, учёные 10%, дикие 34%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 005 --out-dir tmp/floor-maps/genfix_005_after`
