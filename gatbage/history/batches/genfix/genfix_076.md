# genfix_076: сервисные штреки, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/076_z-25_procedural_z-25_сервисные_штреки,_гражданский_этаж.png`
- Route: procedural `z-25`, z-25, index 076/101
- Procedural profile: geometry `service_spines`, anomaly `none`, majority `citizens`, danger 3
- Current metrics: rooms 85, doors 196, containers 14, entities 1590, reachable 114640, walls 933920, floors 114656
...
```text
076_z-25_procedural_z-25_сервисные_штреки,_гражданский_этаж.png
плохо
```
...
- Процедурный профиль: geometry=service_spines, anomaly=none, majority=citizens, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 076 --out-dir tmp/floor-maps/genfix_076_after`
