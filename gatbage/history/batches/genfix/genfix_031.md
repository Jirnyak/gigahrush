# genfix_031: Марковская лестница

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/031_z+20_design_markov_stairwell_Марковская_лестница.png`
- Route: design `markov_stairwell`, z+20, index 031/101
- Design route id: `markov_stairwell`, role: лестничная цепь, вероятные комнаты, срез, danger 3
- Current metrics: rooms 34, doors 48, containers 3, entities 1802, reachable 107643, walls 940931, floors 107645
...
- Target control shares: граждане 34%, ликвидаторы 24%, культисты 10%, учёные 14%, дикие 18%.
...
```text
031_z+20_design_markov_stairwell_Марковская_лестница.png
возможно интересно но видно что недодедлано и масштабы неучтены
нужно добавлять много микро и улучшать алгоритм
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 34%, ликвидаторы 24%, культисты 10%, учёные 14%, дикие 18%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 031 --out-dir tmp/floor-maps/genfix_031_after`
...
- `./node_modules/.bin/tsx --test tests/markov-stairwell.test.ts`
- `npm run typecheck`
