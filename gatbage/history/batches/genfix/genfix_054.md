# genfix_054: сортировочный конвейер: коммунальные узлы, дикий этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/054_z-3_procedural_z-3_сортировочный_конвейер_коммунальные_узлы,_дикий_этаж.png`
- Route: procedural `z-3`, z-3, index 054/101
- Procedural profile: geometry `communal_knots`, anomaly `conveyor_sorter`, majority `wild`, danger 2
- Current metrics: rooms 127, doors 286, containers 20, entities 901, reachable 161858, walls 886702, floors 161874
...
```text
054_z-3_procedural_z-3_сортировочный_конвейер_коммунальные_узлы,_дикий_этаж.png
интересно и неплохо
```
...
- Процедурный профиль: geometry=communal_knots, anomaly=conveyor_sorter, majority=wild, danger=2. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 054 --out-dir tmp/floor-maps/genfix_054_after`
