# genfix_004: зеркальная проводка: чердачные венткамеры, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/004_z+47_procedural_z47_зеркальная_проводка_чердачные_венткамеры,_научная_смена.png`
- Route: procedural `z47`, z+47, index 004/101
- Procedural profile: geometry `attic_weatherworks`, anomaly `mirror_run`, majority `scientists`, danger 4
- Current metrics: rooms 86, doors 194, containers 38, entities 1710, reachable 76114, walls 972446, floors 76130
...
```text
004_z+47_procedural_z47_зеркальная_проводка_чердачные_венткамеры,_научная_смена.png
аналогично пустые коридоры
```
...
- Процедурный профиль: geometry=attic_weatherworks, anomaly=mirror_run, majority=scientists, danger=4. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `src/gen/procedural_anomalies/mirror_run.ts`
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 004 --out-dir tmp/floor-maps/genfix_004_after`
