# genfix_077: Коллекторы

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/077_z-26_story_story_maintenance_Коллекторы.png`
- Route: story `story_maintenance`, z-26, index 077/101
- Story route key: `story_maintenance`
- Current metrics: rooms 4497, doors 75, containers 39, entities 8566, reachable 287407, walls 760998, floors 287578
...
- Target control shares: граждане 16%, ликвидаторы 58%, культисты 5%, учёные 7%, дикие 14%.
...
```text
077_z-26_story_story_maintenance_Коллекторы.png
хороший этаж
оригинальный и образцовый
возможно недоделаны каналы воды потому что их мало но в целом это один из лучших этажей наряду с квартирами министерством и жилым
```
...
- `tests/maintenance-geometry.test.ts`
- `factions.md`
...
- Faction control starts from HQs and approximately matches target shares: граждане 16%, ликвидаторы 58%, культисты 5%, учёные 7%, дикие 14%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 077 --out-dir tmp/floor-maps/genfix_077_after`
...
- `./node_modules/.bin/tsx --test tests/maintenance-geometry.test.ts`
- `npm run typecheck`
