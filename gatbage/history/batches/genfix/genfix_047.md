# genfix_047: Коммунальное кольцо

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/047_z+4_design_communal_ring_Коммунальное_кольцо.png`
- Route: design `communal_ring`, z+4, index 047/101
- Design route id: `communal_ring`, role: социальный обход, danger 2
- Current metrics: rooms 162, doors 103, containers 14, entities 4110, reachable 130405, walls 918081, floors 130407
...
- Target control shares: граждане 54%, ликвидаторы 18%, культисты 7%, учёные 9%, дикие 12%.
...
```text
047_z+4_design_communal_ring_Коммунальное_кольцо.png
макро хорошее
но надо добавитьь микрокомнат между коридорами 
...
- Faction control starts from HQs and approximately matches target shares: граждане 54%, ликвидаторы 18%, культисты 7%, учёные 9%, дикие 12%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 047 --out-dir tmp/floor-maps/genfix_047_after`
...
- `./node_modules/.bin/tsx --test tests/communal-ring.test.ts`
- `npm run typecheck`
