# genfix_071: Гиперболическая стрелочная

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/071_z-20_design_hyperbolic_switchyard_Гиперболическая_стрелочная.png`
- Route: design `hyperbolic_switchyard`, z-20, index 071/101
- Design route id: `hyperbolic_switchyard`, role: дуги, ложные платформы, стрелочные семейства, danger 4
- Current metrics: rooms 28, doors 33, containers 5, entities 2821, reachable 103443, walls 945131, floors 103445
...
- Target control shares: граждане 12%, ликвидаторы 44%, культисты 8%, учёные 16%, дикие 20%.
...
```text
071_z-20_design_hyperbolic_switchyard_Гиперболическая_стрелочная.png
ОЧЕНЬ ИНТЕРЕСНОЕ МАКРО
это потенциально хорошо
но нужно доделать
в центре структуры очень интересные и оригинальные но вокруг снаружи пусто
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 12%, ликвидаторы 44%, культисты 8%, учёные 16%, дикие 20%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 071 --out-dir tmp/floor-maps/genfix_071_after`
...
- `./node_modules/.bin/tsx --test tests/hyperbolic-switchyard.test.ts`
- `npm run typecheck`
