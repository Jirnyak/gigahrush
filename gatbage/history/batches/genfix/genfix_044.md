# genfix_044: коммунальные узлы, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/044_z+7_procedural_z7_коммунальные_узлы,_гражданский_этаж.png`
- Route: procedural `z7`, z+7, index 044/101
- Procedural profile: geometry `communal_knots`, anomaly `none`, majority `citizens`, danger 1
- Current metrics: rooms 118, doors 259, containers 13, entities 640, reachable 169893, walls 878667, floors 169909
...
```text
044_z+7_procedural_z7_коммунальные_узлы,_гражданский_этаж.png
хороший этаж 
возможно стоит улучшить чтобы коридоры не сливались
но в целом норм
```
...
- Процедурный профиль: geometry=communal_knots, anomaly=none, majority=citizens, danger=1. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 044 --out-dir tmp/floor-maps/genfix_044_after`
