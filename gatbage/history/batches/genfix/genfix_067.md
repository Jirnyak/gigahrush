# genfix_067: сервисные штреки, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/067_z-16_procedural_z-16_сервисные_штреки,_научная_смена.png`
- Route: procedural `z-16`, z-16, index 067/101
- Procedural profile: geometry `service_spines`, anomaly `none`, majority `scientists`, danger 2
- Current metrics: rooms 77, doors 164, containers 12, entities 1169, reachable 112182, walls 936378, floors 112198
...
```text
067_z-16_procedural_z-16_сервисные_штреки,_научная_смена.png
...
- Процедурный профиль: geometry=service_spines, anomaly=none, majority=scientists, danger=2. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 067 --out-dir tmp/floor-maps/genfix_067_after`
