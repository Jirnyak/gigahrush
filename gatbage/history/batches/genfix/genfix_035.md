# genfix_035: Больничный корпус

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/035_z+16_design_bolnichny_korpus_Больничный_корпус.png`
- Route: design `bolnichny_korpus`, z+16, index 035/101
- Design route id: `bolnichny_korpus`, role: медицина, карантин, палаты и допуски, danger 4
- Current metrics: rooms 76, doors 88, containers 5, entities 2408, reachable 141910, walls 906663, floors 141913
...
- Target control shares: граждане 24%, ликвидаторы 22%, культисты 6%, учёные 38%, дикие 10%.
...
```text
035_z+16_design_bolnichny_korpus_Больничный_корпус.png
ХОРОШО
хорошее макро
но как обычно надо добавлять микро масштабы комнаты помещения скалды коридорчики
```
...
- `tests/bolnichny-korpus.test.ts`
- `factions.md`
...
- Faction control starts from HQs and approximately matches target shares: граждане 24%, ликвидаторы 22%, культисты 6%, учёные 38%, дикие 10%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 035 --out-dir tmp/floor-maps/genfix_035_after`
...
- `./node_modules/.bin/tsx --test tests/bolnichny-korpus.test.ts`
- `npm run typecheck`
