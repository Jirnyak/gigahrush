# genfix_012: говнячный смог: чердачные венткамеры, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/012_z+39_procedural_z39_говнячный_смог_чердачные_венткамеры,_гражданский_этаж.png`
- Route: procedural `z39`, z+39, index 012/101
- Procedural profile: geometry `attic_weatherworks`, anomaly `smog`, majority `citizens`, danger 4
- Current metrics: rooms 86, doors 204, containers 27, entities 1808, reachable 84597, walls 963963, floors 84613
...
```text
012_z+39_procedural_z39_говнячный_смог_чердачные_венткамеры,_гражданский_этаж.png
ПЛОХО 
...
- Процедурный профиль: geometry=attic_weatherworks, anomaly=smog, majority=citizens, danger=4. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 012 --out-dir tmp/floor-maps/genfix_012_after`
