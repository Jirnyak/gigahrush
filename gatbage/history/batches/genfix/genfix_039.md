# genfix_039: НИИ слизи

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/039_z+12_design_slime_nii_НИИ_слизи.png`
- Route: design `slime_nii`, z+12, index 039/101
- Design route id: `slime_nii`, role: биолаборатории, карантин, камеры со слизью, danger 4
- Current metrics: rooms 84, doors 103, containers 13, entities 3008, reachable 132988, walls 915586, floors 132990
...
- Target control shares: граждане 14%, ликвидаторы 12%, культисты 6%, учёные 60%, дикие 8%.
...
```text
039_z+12_design_slime_nii_НИИ_слизи.png
хорошее макро но масштабы не учтены
нужны кабинеты больше складов комнат микро нету
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 14%, ликвидаторы 12%, культисты 6%, учёные 60%, дикие 8%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 039 --out-dir tmp/floor-maps/genfix_039_after`
