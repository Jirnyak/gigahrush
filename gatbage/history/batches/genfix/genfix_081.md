# genfix_081: Склад Гильберта

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/081_z-30_design_hilbert_depot_Склад_Гильберта.png`
- Route: design `hilbert_depot`, z-30, index 081/101
- Design route id: `hilbert_depot`, role: индексный склад, короткие хорды, лут, danger 4
- Current metrics: rooms 50, doors 70, containers 30, entities 2321, reachable 89118, walls 959456, floors 89120
...
- Target control shares: граждане 14%, ликвидаторы 42%, культисты 8%, учёные 20%, дикие 16%.
...
```text
081_z-30_design_hilbert_depot_Склад_Гильберта.png
потенциал есть но недоделано
снаружи пусто 
нужно доделывать алгоритм 
но может стать интересным
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 14%, ликвидаторы 42%, культисты 8%, учёные 20%, дикие 16%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 081 --out-dir tmp/floor-maps/genfix_081_after`
...
- `./node_modules/.bin/tsx --test tests/hilbert-depot.test.ts`
- `npm run typecheck`
