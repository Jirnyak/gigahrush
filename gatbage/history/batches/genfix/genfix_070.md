# genfix_070: говнячный смог: сервисные штреки, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/070_z-19_procedural_z-19_говнячный_смог_сервисные_штреки,_гражданский_этаж.png`
- Route: procedural `z-19`, z-19, index 070/101
- Procedural profile: geometry `service_spines`, anomaly `smog`, majority `citizens`, danger 3
- Current metrics: rooms 85, doors 196, containers 21, entities 1574, reachable 117425, walls 931135, floors 117441
...
```text
070_z-19_procedural_z-19_говнячный_смог_сервисные_штреки,_гражданский_этаж.png
недоделано
```
...
- Процедурный профиль: geometry=service_spines, anomaly=smog, majority=citizens, danger=3. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 070 --out-dir tmp/floor-maps/genfix_070_after`
