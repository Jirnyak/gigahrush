# genfix_048: жилая нарезка, научная смена

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/048_z+3_procedural_z3_жилая_нарезка,_научная_смена.png`
- Route: procedural `z3`, z+3, index 048/101
- Procedural profile: geometry `living_blocks`, anomaly `none`, majority `scientists`, danger 1
- Current metrics: rooms 92, doors 80, containers 10, entities 640, reachable 21006, walls 1027554, floors 21022
...
```text
048_z+3_procedural_z3_жилая_нарезка,_научная_смена.png
нужно заполнить алгоритмом весь этаж
замысел хороший но недоделано
```

## Diagnosis

- Главная проблема: генератор останавливается слишком рано и оставляет внешний/межкоридорный объем без структуры.
- Процедурный профиль: geometry=living_blocks, anomaly=none, majority=scientists, danger=1. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 048 --out-dir tmp/floor-maps/genfix_048_after`
