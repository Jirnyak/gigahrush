# genfix_034: поражение самосбором: плотные квартиры, гражданский этаж

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/034_z+17_procedural_z17_поражение_самосбором_плотные_квартиры,_гражданский_этаж.png`
- Route: procedural `z17`, z+17, index 034/101
- Procedural profile: geometry `apartment_pressure`, anomaly `samosbor_seed`, majority `citizens`, danger 4
- Current metrics: rooms 128, doors 324, containers 17, entities 1919, reachable 39475, walls 1009085, floors 39491
...
- Target control shares: граждане 51%, ликвидаторы 15%, культисты 6%, учёные 7%, дикие 11%, самосбор 10%.
- Dominant owner: граждане; reason: procedural majority citizens plus samosbor pressure.
...
```text
034_z+17_procedural_z17_поражение_самосбором_плотные_квартиры,_гражданский_этаж.png
плохо
```
...
- Процедурный профиль: geometry=apartment_pressure, anomaly=samosbor_seed, majority=citizens, danger=4. Исправление должно усиливать семейство геометрии/аномалии универсально, а не под один PNG.
...
- Faction control starts from HQs and approximately matches target shares: граждане 51%, ликвидаторы 15%, культисты 6%, учёные 7%, дикие 11%, самосбор 10%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 034 --out-dir tmp/floor-maps/genfix_034_after`
