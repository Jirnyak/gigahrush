...
- Map: `tmp/floor-maps/all_route_seed_61061/055_z-4_design_floor_69_Этаж_69.png`
- Route: design `floor_69`, z-4, index 055/101
- Design route id: `floor_69`, role: населенный сбой, сделки, слухи, danger 3
- Current metrics: rooms 77, doors 87, containers 6, entities 2589, reachable 47996, walls 996499, floors 52077
...
- Target control shares: граждане 18%, ликвидаторы 9%, культисты 8%, учёные 7%, дикие 58%.
...
```text
055_z-4_design_floor_69_Этаж_69.png
ХОРОШО 
макро хорошее но много пустого простраснтва которое можно разнообразно заполнить но основа хорошая
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 18%, ликвидаторы 9%, культисты 8%, учёные 7%, дикие 58%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 055 --out-dir tmp/floor-maps/genfix_055_after`
