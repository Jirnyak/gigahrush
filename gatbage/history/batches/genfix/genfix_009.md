# genfix_009: Антенный двор

## Route target

- Map: `tmp/floor-maps/all_route_seed_61061/009_z+42_design_antenna_court_Антенный_двор.png`
- Route: design `antenna_court`, z+42, index 009/101
- Design route id: `antenna_court`, role: связь, наружный ветер, обзор, danger 2
- Current metrics: rooms 18, doors 26, containers 6, entities 3470, reachable 217716, walls 830858, floors 217718
...
- Target control shares: граждане 18%, ликвидаторы 36%, культисты 8%, учёные 24%, дикие 14%.
...
```text
009_z+42_design_antenna_court_Антенный_двор.png
ИНТЕРЕСНАЯ МАКРОСТРУКТУРА
но нарушены масштабы и нет маленьких комнат над добавить
```
...
- Faction control starts from HQs and approximately matches target shares: граждане 18%, ликвидаторы 36%, культисты 8%, учёные 24%, дикие 14%.
...
- `./node_modules/.bin/tsx scripts/render-procedural-floor-map.ts --seed 61061 --all --entry 009 --out-dir tmp/floor-maps/genfix_009_after`
