...
Status: partially shipped data/content pass as of 2026-05-25. Created 2026-05-24 for a future GPT-5.5 worker; keep the remaining backlog as design intake, not shipped behavior.

Implemented pass: sampleware, NII labels/forms, slime age/sample evidence, gas/cold/meat anomaly loot, medical consumables, hygiene goods and concentrate food were added or improved through `src/data/items.ts`, `src/data/resources.ts`, existing trade pools and narrow NII/Hladon/monster source hooks. No contamination simulation or save shape change was added.
