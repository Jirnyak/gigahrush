...
- Read `README.md`, `architecture.md`, `desdoc.md`, `monsters.md`, `gatbage/history/root_notes/monsters.md` section for `ocherednik`, `AGENTS.md`, and required source files.
- Baseline command:
