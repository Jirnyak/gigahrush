...
- Read `README.md`, `architecture.md`, `desdoc.md`, `monsters.md`, `gatbage/history/root_notes/monsters.md`, and `AGENTS.md`.
...
- Current stats fit the trash/swarm pressure band from `gatbage/history/root_notes/monsters.md`: hp 14, speed 2.45, dmg 3.
