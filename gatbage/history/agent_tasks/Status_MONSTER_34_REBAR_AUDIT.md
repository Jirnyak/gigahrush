...
- Read-only audit files checked: `README.md`, `architecture.md`, `desdoc.md`, `monsters.md`, `gatbage/history/root_notes/monsters.md`, `AGENTS.md`, `src/entities/monster.ts`, `src/data/monster_ecology.ts`, `src/data/monster_variants.ts`, `src/gen/design_floors/production_belt.ts`, `src/systems/ai/monster.ts`
