...
- `../../floors.md` only if the central floor-system contract changes materially; archived root `geometry.md` lives in `../../gatbage/history/root_notes/geometry.md` for historical comparison.
