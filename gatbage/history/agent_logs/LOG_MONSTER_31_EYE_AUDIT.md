...
- Read required docs and sources: `README.md`, `architecture.md`, `desdoc.md`, `monsters.md`, `gatbage/history/root_notes/monsters.md`, `AGENTS.md`, `src/entities/eye.ts`, `src/entities/monster.ts`, `src/data/monster_ecology.ts`, `src/data/monster_variants.ts`, `src/systems/ai/monster.ts`, and `src/render/sprite_index.ts`.
