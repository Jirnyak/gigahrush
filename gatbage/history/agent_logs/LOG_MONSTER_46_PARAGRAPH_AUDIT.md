...
- Read required docs and sources: `README.md`, `architecture.md`, `desdoc.md`, `monsters.md`, `gatbage/history/root_notes/monsters.md`, `AGENTS.md`, `src/entities/paragraph.ts`, `src/entities/monster.ts`, `src/data/monster_ecology.ts`, `src/systems/ai/monster.ts`, `src/gen/ministry/document_gate.ts`, and `src/gen/void/protocol_chamber.ts`.
