...
async function runPublicPageProbe() {
  ...
  const scriptPath = process.argv[1] || "gatbage/media/itch_page_pack/probe_itch_editor.js";
...
function printPublicProbeHelp() {
  console.log(`Usage:
  node gatbage/media/itch_page_pack/probe_itch_editor.js [--public] [--url URL]
