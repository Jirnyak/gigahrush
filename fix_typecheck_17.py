...
replace_in_files(r'\bgiverNpcId\b', 'giverId', 'src/**/*.ts')
replace_in_files(r'\bfailOnNpcDeathPlotId\b', 'failOnNpcDeathId', 'src/**/*.ts')
replace_in_files(r'\btargetPlotNpcId\b', 'targetNpcId', 'src/**/*.ts')
