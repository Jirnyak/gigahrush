...
`Docs/UXRework/` - активный пакет осторожных rework-брифов по первому публичному фидбеку. Его задача не "упростить игру" и не вырезать системы, а снизить первое отторжение от громоздкости: сделать первый экран, первую цель, первый NPC, бой, сообщения и опасности читаемыми без поломки уже работающего функционала.

## 0. UX-фидбек 2026-05-24: Осторожный Rework
...
1. **Показывать одну текущую цель.** Первый экран должен вести к Ольге, затем к Барни, обратно к Ольге и к Якову. Это уже существующая сюжетная дорожка; нужно сделать ее видимой, а не писать новый туториал.
...
- Миникарта и `M`-карта больше не являются полной схемой этажа: `src/systems/map_exploration.ts` хранит UI-only fog-of-war по текущему `World`, старт раскрывает проходимую геометрию стартовой макро-зоны вместе с комнатами и коридорами, вход в комнату раскрывает ее, route-cue/картографические знания могут раскрывать цели, зоны и участки, не-стены на границе открытого участка визуально затухают в неизвестность, а локальная самосборная волна снова закрывает перестроенный участок.
- 253 item ids.
...
- `Docs/UXRework/rework_01_first_playable_path.md`;
- `Docs/UXRework/rework_02_ui_orchestrator_presets.md`;
- `Docs/UXRework/rework_03_hud_layout_slots.md`;
- `Docs/UXRework/rework_04_message_log_and_bark_triage.md`;
- `Docs/UXRework/rework_05_route_map_clarity.md`;
- `Docs/UXRework/rework_orchestrator.md`.

Сделать только low-risk улучшения:

- current objective: первая цель "поговорить с Ольгой" видна сразу;
- стартовая цепочка: Ольга -> Барни -> Ольга -> Яков читается без знания исходников;
