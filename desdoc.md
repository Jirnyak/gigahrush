...
- Вертикальный `FloorRun`: нормальный лифтовой span `z=-44..40`, 24 authored/story stops, из них 6 story `FloorLevel` anchors и 18 design floor routes/generators, плюс 61 процедурный сидовый этаж между ручными якорями без добавления новых `FloorLevel`.
...
| Вертикальный маршрут | `FloorRun` `z=-44..40`, 18 design floors, 61 procedural floors, numbered lift anomalies | понятная навигация: route id, danger, anomaly, return path, contract target | понимает ли игрок, куда его везет лифт и почему это не просто случайность? |
