...
Authority: `expansion.md`, `content_manifest.md`, `integration_contract.md`, `Docs/Expansions/00_samosbor_director/expansion.md`, `Docs/Expansions/00_samosbor_director/integration_contract.md`  
