...
Статус: план будущей реализации. Код не менялся. Документ описывает playable MVP метро в рамках `Docs/Expansions/02_metro_error_line/expansion.md` и не требует немедленного расширения `FloorLevel`.
