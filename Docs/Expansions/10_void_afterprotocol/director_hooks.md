...
Owner scope: `Docs/Expansions/10_void_afterprotocol/**`  
Director dependency: `Docs/Expansions/00_samosbor_director` rare-tick scheduler, beat registry, chain state, and trace buffer  
