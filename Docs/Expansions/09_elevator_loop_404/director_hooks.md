...
Authority: `expansion.md`, `content_manifest.md`, `implementation_plan.md`, `integration_contract.md`, and `Docs/Expansions/00_samosbor_director/{expansion.md,integration_contract.md,director_hooks.md}`.
