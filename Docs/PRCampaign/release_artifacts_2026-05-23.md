...
Purpose: local artifact manifest for the big-redesign PR/upload pass. These files are local generated artifacts, not source files to commit.
...
| --- | --- | ---: | --- | --- |
| HTML5 portal build copy | `tmp/prcampaign_2026-05-23/gigahrush_html5_portal_build_2026-05-23.zip` | 4.8 MB | `fa63dd2be47292814989234482f40597b23fa58df2ec3ab823992953f6c66321` | Copy of the current HTML5 ZIP for portal upload forms. |
| Portal visuals | `tmp/prcampaign_2026-05-23/gigahrush_portal_visuals_2026-05-23.zip` | 13 MB | `84691e790ba997053d036f68afcf15e0f93bb95211f6dc8ddfcbd26762b07ef0` | Strong screenshots plus cover/social/capsule assets. |
| Press kit media | `tmp/prcampaign_2026-05-23/gigahrush_press_kit_media_2026-05-23.zip` | 20 MB | `f14256545f9593fbc86bb9014847cedd6f933b86b5692fadd9c8e52a27c7c077` | 8 visuals, GIFs, cover/social/capsules/poster, RU/EN copy docs. |
| Itch gallery pack | `tmp/prcampaign_2026-05-23/gigahrush_itch_gallery_2026-05-23.zip` | 28 MB | `d3b85c8997309d149a83cec27f3cfe3b84df1483b366b6d5fe5d904f5b338eff` | Current approved frontpage screenshots plus optimized GIFs. |

## Current Selected Media

Owner-updated best picks are now in `tmp/prcampaign_screenshot_hunt_2026-05-23/selected_best/`. Future PR/upload agents should take screenshots, GIFs and the contact sheet from that folder first, not from older loose hunt folders.

- Square 3x3 sheet: `tmp/prcampaign_screenshot_hunt_2026-05-23/selected_best/contact_sheet_3x3.png`, 1 920 x 1 920 PNG, 2 253 839 bytes, SHA-256 `c9a45173c944fa6074aa4cf2a0b9894acff484c4d3082251c1ea522a96f37c39`.
- Compatibility filename: `tmp/prcampaign_screenshot_hunt_2026-05-23/selected_best/contact_sheet_png.png` is the same 3x3 image.
...
- Use `itch/gigahrush-itch.zip` or the identical `tmp/prcampaign_2026-05-23/gigahrush_html5_portal_build_2026-05-23.zip` for generic HTML5 ZIP upload forms only if this local artifact remains the intended current build; public itch currently serves a different `index.html` hash.
