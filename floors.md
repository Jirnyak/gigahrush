...
- `gatbage/reference/design_floors/`: authored floor packets.
- `gatbage/reference/procedural_floors/`: procedural geometry/anomaly authoring details.
