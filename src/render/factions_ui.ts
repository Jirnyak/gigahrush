...
function drawRelationMatrix(
  ...
  ctx.lineWidth = 1;
  ctx.font = `bold ${labelFontSize}px "Pixelify Sans", monospace`;
...
function drawFactionSnapshotPanel(
  ...
  ctx.font = `bold ${9 * sy}px "Pixelify Sans", monospace`;
  ctx.fillStyle = '#0ca';
...
function drawRankRow(
  ...
  ctx.font = `${7.5 * sy}px "Pixelify Sans", monospace`;
  ctx.textAlign = 'left';
  ctx.textBaseline = 'top';
...
export function drawFactionMenu(
  ...
  // Title
  ctx.font = `bold ${12 * sy}px "Pixelify Sans", monospace`;
  ctx.textAlign = 'center';
