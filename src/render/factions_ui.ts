...
function drawRelationMatrix(
  ...
  ctx.lineWidth = 1;
  ctx.font = `bold ${labelFontSize}px "VT323", monospace`;
...
function drawFactionSnapshotPanel(
  ...
  ctx.font = `bold ${9 * sy}px "VT323", monospace`;
  ctx.fillStyle = '#0ca';
...
function drawRankRow(
  ...
  ctx.font = `${7.5 * sy}px "VT323", monospace`;
  ctx.textAlign = 'left';
  ctx.textBaseline = 'top';
...
export function drawFactionMenu(
  ...
  // Title
  ctx.font = `bold ${12 * sy}px "VT323", monospace`;
  ctx.textAlign = 'center';
