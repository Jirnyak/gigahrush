 ...
 * шину поперёк кадра и упирается в боковой столбец холста, который приходится на
 * треть ширины экрана; отвесная прячет зубья за собственным корпусом. Диагональ
 ...
 * уходит нос шины на пике замаха. Столбцы 0 и 63 — боковые края холста: шина
 * длинная и лезет вбок сразу за древковыми. Наружу можно только вниз.
 */
const TOP_ROW = 10;
 ...
 *
 * Уходят они вниз, а не в боковые углы: кулаки сидят на строках 66..100, и конус
 * из них в угол пересёк бы край холста ВЫШЕ полосы HUD, где край приходится на
 * треть ширины экрана.
 */
