 ...
 *
 * В БОКОВЫЕ края холста упираться нельзя: они приходятся на треть ширины экрана,
 * и силуэт оборвался бы прямым срезом в воздухе. Это правило нарушал именно
 * пулемёт и стоило отдельной починки: наружу можно только вниз.
 */
...
registerViewmodel({
  ...
  draw({ buf, frame, skin, rand }) {
     ...
     * треть ширины экрана и дал бы вертикальный срез в воздухе. */
