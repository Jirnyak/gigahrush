 ...
 * можно и нужно. Правый край холста приходится на столбец 127, а оружие
 * зеркально прижато к правому краю кадра и начинается со столбца 192: за кадр
 * они больше не спорят, весь холст свободен. Читаемое живёт в строках 22..100
 * (у инструмента 30..100: он вспомогательный и держится ниже), строки 100..127
 * закрывает полоса HUD.
 */
