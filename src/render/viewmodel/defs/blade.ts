 ...
 * левый край холста, он приходится на середину кадра, и дошедший до него силуэт
 * обрывается вертикальным срезом в воздухе. Столбец 63 упирается в край экрана:
 * наружу можно вправо и вниз, поэтому нижняя граница здесь одна — конец сетки.
 */
const TOP_ROW = 10;
