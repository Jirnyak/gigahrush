 ...
 * экрана, и упираться в него МОЖНО — срез там не виден. Правый край приходится
 * на столбец 127; оружие зеркально прижато к правому краю кадра и начинается со
 * столбца 192, так что перекрыть инструмент оно больше не может — весь холст
 * свободен. Строка холста `r` — строка экрана `80 + r`; читаемое живёт в строках
 * 30..100, ниже всё съедает полоса HUD.
 */
