...
export const DEF: MonsterDef = {
  ...
  windup: {
    ...
    minRange: 0.75,
    color: '#7f9',
    warningLine: 'В черной воде рябь пошла против течения: чернослиз держит грязную линию.',
    windupLine: 'Чернослиз раскрывает зеленую щель в воде. Угол, сухая кромка или свет срывают первый залп.',
    interruptLine: 'Рябь чернослиза погасла за углом или сухой кромкой. Сейчас можно сближаться.',
  },
};
