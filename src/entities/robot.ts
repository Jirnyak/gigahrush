...
export const DEF: MonsterDef = {
  ...
  windup: {
    ...
    minRange: 1.5,
    color: '#6cf',
    warningLine: 'Робот взял линию плазмы. После залпа у него есть пауза.',
    windupLine: 'Робот раскручивает плазму. Сойдите с линии и бейте после вспышки.',
    interruptLine: 'Плазменная линия Робота сорвалась. Пауза короткая, сближайтесь.',
  },
};
