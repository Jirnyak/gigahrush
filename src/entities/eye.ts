...
export const DEF: MonsterDef = {
  ...
  uv: { effect: 'eye_stun', attackCd: 2.2, daze: 1.4, wander: true },
  ...
  windup: {
    ...
    minRange: 1.5,
    color: '#cf6',
    warningLine: 'Глаз держит прямую линию. Зеленый разогрев читается до выстрела.',
    windupLine: 'Глаз разогревает зелёную линию огня. Угол, дверь или шкаф сорвут выстрел.',
    interruptLine: 'Выстрел Глаза сорвался о стену или укрытие. Держите угол до вспышки.',
  },
};
