...
export const DEF: MonsterDef = {
  ...
  sprite: 0,
  detect: 26,
  aiFlags: ['protocolPressure', 'foodBait'],
  ...
  /* Строка семьи спецудара. Пульс сверки бьёт пси-давлением: крови нет, и
     подписывается он не именем вида, а самим протоколом. */
  strike: {
    hurt: 'Протокол сжал виски',
    blood: false,
  },
};
