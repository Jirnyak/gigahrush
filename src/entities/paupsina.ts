...
export const DEF: MonsterDef = {
  ...
  windup: {
    ...
    minRange: 3.4,
    color: '#ddd',
    warningLine: 'Паупсина держит липкую прямую. Сеть не убивает, но ловит ноги на несколько секунд.',
    windupLine: 'Паупсина присела на передние лапы: сейчас плюнет сетью. Шкаф, дверь или ближний напор срывают плевок.',
    interruptLine: 'Плевок Паупсины сорвался о бетон или мебель. Давите дистанцию, пока она переставляет лапы.',
  },
};
