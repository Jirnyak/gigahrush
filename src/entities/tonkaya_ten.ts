...
export const DEF: MonsterDef = {
  ...
  sprite: 0,
  aiFlags: ['baitLine'],
  /* Бросок во фланг: единственный член семьи, который ВЫБИРАЕТ точку, а не
   * шагает по вектору, поэтому длины шага у него нет — предел досягаемости
   * задаёт сама ловушка. Упёршись, пробует следующего кандидата, а не скользит. */
  dash: {
    damageMult: 2.9,
  ...
  /* Строка семьи спецудара: удар с подготовленной тёмной линии. */
  strike: {
    hurt: '%s ударила с темной линии',
    kill: '%s увела и убила %t',
  },
};
