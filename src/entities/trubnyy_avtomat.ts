...
export const DEF: MonsterDef = {
  ...
  /* Строка семьи замаха. Дальность — предел мокрой прямой в клетках. */
  windup: {
    windupSec: 1.05,
    range: 18,
    minRange: 2.25,
    color: '#6cf',
    tag: 'trubnyy_avtomat',
    warningLine: 'Трубный Автомат нашел мокрую прямую. Синяя зарядка читается до выстрела.',
    windupLine: 'Синие кольца Трубного Автомата ярчают по воде. Сойдите с линии до вспышки.',
    interruptLine: 'Трубный Автомат потерял мокрую прямую. Фланг или сухая клетка сорвали заряд.',
