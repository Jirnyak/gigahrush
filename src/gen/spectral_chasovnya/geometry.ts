...
export function findSpectralRooms(world: World): SpectralRooms | undefined {
...
export function ensureSpectralChasovnyaState(world: World): SpectralChasovnyaState | undefined {
...
export function setRoomStyle(world: World, room: Room, wallTex: Tex, floorTex: Tex, fog = 0): void {
...
export function stampSpectralRoom(
  world: World,
  type: RoomType,
  x: number,
  y: number,
...
export function connectCenters(world: World, a: Room, b: Room): void {
...
export function placeLift(world: World, room: Room, x: number, y: number, direction: LiftDirection): void {
  const ci = world.idx(x, y);
...
export function decorateStandingWave(world: World, room: Room, pitch: number): void {
...
export function countRoomFloorCells(world: World, room: Room): number {
  let count = 0;
  for (let dy = 0; dy < room.h; dy++) {
    for (let dx = 0; dx < room.w; dx++) {
      const ci = world.idx(room.x + dx, room.y + dy);
...
export function canStampSpectralRect(world: World, x: number, y: number, w: number, h: number): boolean {
...
export function tryStampSpectralRoom(
  world: World,
  type: RoomType,
  x: number,
  y: number,
...
export function decorateSpectralRoom(world: World, room: Room): void {
...
export function decorateEchoCourt(world: World, room: Room, serial: number): void {
...
export function carveWideCorridor(world: World, ax: number, ay: number, bx: number, by: number, radius: number): void {
...
export function connectRoomToPoint(world: World, room: Room, x: number, y: number, wide = 0): void {
...
export function roomByNearestAngle(rooms: readonly Room[], angle: number): Room | undefined {
...
export function styleForOwner(owner: TerritoryOwner): { wallTex: Tex; floorTex: Tex; fog: number } {
  switch (owner) {
...
export function stampSpectralHqCompound(world: World, spec: SpectralHqSpec): Room[] {
  const out: Room[] = [];
...
export function paintOwnerPatch(world: World, x: number, y: number, owner: TerritoryOwner, radius = 18): void {
...
export function hardenSpectralHqCore(world: World, room: Room, owner: TerritoryOwner): void {
...
export function stampSpectralEchoCourts(world: World): Room[] {
  const rooms: Room[] = [];
  const specs = [
    [250, 238, 96, 54],
    [438, 202, 104, 58],
...
export function stampSpectralOuterDistricts(world: World): Room[] {
  const rooms: Room[] = [];
  const courts = [
...
export function stampSpectralRingStations(world: World): Room[] {
  const halls: Room[] = [];
  const rings = [
...
export function stampSpectralStationMicroRooms(world: World, hall: Room, ringIndex: number, stationIndex: number, angle: number): void {
...
export function carveSpectralMacroNetwork(world: World, rooms: SpectralRooms, halls: readonly Room[], courts: readonly Room[], hqs: readonly Room[]): void {
...
export function expandSpectralRouteGeometry(world: World, rooms: SpectralRooms): void {
  const hqRooms: Room[] = [];
...
export function buildRooms(world: World): SpectralRooms {
  const cx = W >> 1;
  const cy = W >> 1;
  const rooms = {
...
export function dressRooms(world: World, rooms: SpectralRooms): void {
...
export function makeStandingWaveRoom(id: string, room: Room, wavelengthCells: number, pressure: SpectralStandingWaveRoom['pressure'], decisions: SpectralDecision[], tags: string[]): SpectralStandingWaveRoom {
  const c = roomCenter(room);
  return {
    id,
    roomDefId: room.name,
...
export function makeShadowZone(world: World, id: string, room: Room, radius: number, decisions: SpectralDecision[], tags: string[]): SpectralShadowZone {
  const c = roomCenter(room);
  return {
    id,
    roomDefId: room.name,
...
export function makeBellNode(id: string, room: Room, x: number, y: number, radius: number, tags: string[]): SpectralBellNode {
  return {
    id,
    roomDefId: room.name,
    roomId: room.id,
...
export function buildSpectralState(world: World, rooms: SpectralRooms): SpectralChasovnyaState {
...
export function registerQuietShadowRouteCue(world: World, rooms: SpectralRooms): void {
...
export function registerMainBellRouteCue(world: World, rooms: SpectralRooms, state: SpectralChasovnyaState): void {
...
export function registerFocusWarningRouteCue(world: World, rooms: SpectralRooms): void {
...
export function registerRadioSacristyRouteCue(world: World, rooms: SpectralRooms): void {
...
export function registerSpectralRouteCues(world: World, rooms: SpectralRooms, state: SpectralChasovnyaState): void {
...
export function findBellNodeForLook(world: World, player: Entity, lookX: number, lookY: number): SpectralBellNode | undefined {
