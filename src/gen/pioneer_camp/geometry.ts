...
export function buildCampLandscapeCourts(world: World, mask: Uint8Array, rng: () => number): void {
...
export function decorateCampCourt(world: World, room: Room, rng: () => number, serial: number): void {
...
export function buildCampMidMicroLayer(world: World, mask: Uint8Array): void {
...
export function campMicroRoomSpecs(serial: number): readonly { type: RoomType; dx: number; dy: number; w: number; h: number; name: string; wallTex: Tex; floorTex: Tex }[] {
...
export function decorateCampClusterYard(world: World, yard: Room, serial: number): void {
...
export function decorateCampMicroRoom(world: World, room: Room, serial: number): void {
  switch (room.type) {
...
export function buildCampFactionHqs(world: World, mask: Uint8Array): void {
...
export function decorateCampHqCore(world: World, room: Room, owner: TerritoryOwner): void {
...
export function buildCampHqSupportRooms(world: World, site: CampHqSite): void {
...
export function campHqSupportSpecs(owner: TerritoryOwner): readonly { type: RoomType; name: string; wallTex: Tex; floorTex: Tex }[] {
  switch (owner) {
...
export function markHermeticCampRoom(world: World, room: Room): void {
...
export function paintPioneerCampTerritory(world: World, trailDistance: Int32Array): void {
...
export function bestCampTerritoryOwner(
  world: World,
  cell: number,
...
export function reinforceCampTerritoryAnchors(world: World): void {
  for (const site of CAMP_HQ_SITES) {
...
export function paintCampRoomRectangle(world: World, x: number, y: number, w: number, h: number, owner: TerritoryOwner): void {
...
export function stampCampFaction(world: World, cx: number, cy: number, radius: number, faction: ZoneFaction): void {
...
export function campTrailDistances(world: World, sx: number, sy: number): Int32Array {
...
export function nearestCampWalkableCell(world: World, x: number, y: number, radius: number): number {
...
export function isCampTrailWalkableCell(world: World, ci: number): boolean {
  const cell = world.cells[ci];
  return cell === Cell.FLOOR || cell === Cell.DOOR || cell === Cell.LIFT;
}

export function campZoneBestTrailDistances(world: World, trailDistance: Int32Array): Int32Array {
...
export function scatterConcreteForestTrailPoints(world: World, mask: Uint8Array, rng: () => number): void {
...
export function isConcreteForestTrailCandidate(world: World, mask: Uint8Array, ci: number): boolean {
  return !mask[ci] &&
...
export function initCampWorld(world: World): void {
  for (let i = 0; i < W * W; i++) {
...
export function buildCampCore(world: World): CampRooms {
...
export function buildCampPaths(world: World, rooms: CampRooms): void {
...
export function decorateCampCore(world: World, rooms: CampRooms): void {
...
export function placeCampLifts(world: World, rooms: CampRooms): void {
...
export function tuneCampZones(world: World): void {
  tunePioneerCampPopulationZones(world);
}

export function placeCampDrops(world: World, entities: Entity[], nextId: { v: number }, rooms: CampRooms): void {
...
export function retuneRoom(world: World, room: Room, wallTex: Tex, floorTex: Tex): void {
  for (let dy = -1; dy <= room.h; dy++) {
    for (let dx = -1; dx <= room.w; dx++) {
      const ci = world.idx(room.x + dx, room.y + dy);
...
export function connectCampRoom(
  world: World,
  room: Room,
  doorX: number,
  doorY: number,
...
export function connectCampRoomToHub(
  world: World,
  room: Room,
  hubX: number,
  hubY: number,
...
export function addCampDoor(world: World, room: Room, x: number, y: number, state: DoorState, keyId = ''): number {
...
export function carveBeachAndWater(world: World, boat: Room): void {
...
export function markPosterWall(world: World, x: number, y: number, n: number): void {
  const ci = world.idx(x, y);
...
export function campProtectedMask(world: World): Uint8Array {
...
export function carveSafeTrailLoop(world: World, mask: Uint8Array, x: number, y: number, w: number, h: number, width: number, floorTex: Tex): void {
...
export function connectCampGateToNorthTrail(world: World, mask: Uint8Array): void {
