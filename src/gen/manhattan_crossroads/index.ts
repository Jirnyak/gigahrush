...
import { ensureConnectivity, sanitizeDoors, placeLifts } from '../shared';
...
import { addLogicalRoom, expandManhattanCrossroadsRouteShell, stampDistrictRooms, placeDistrictLifts, applyZones, carveStreetGrid } from './geometry';
import { spawnCrossroadsNpcs, spawnRoadHazards, seedContainersAndDrops } from './npcs';
