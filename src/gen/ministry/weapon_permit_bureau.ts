...
const BORIS_DEF: PlotNpcDef = {
  ...
  talkLines: [
    'Я не подделываю оружейные бумаги. Я помогаю подписи вспомнить, куда она шла.',
...
const STEPAN_DEF: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'Законный путь: разрешение к короткостволу или одноразовый патронный ордер.',
...
registerSideQuest('stepan_patronov', STEPAN_DEF, [
  {
    ...
    type: QuestType.FETCH,
    desc: 'Степан Патронов: «Разрешение на стол. Выдам самодельный пистолет и минимум патронов, без героизма.»',
    targetItem: 'weapon_permit_signed', targetCount: 1,
    rewardItem: 'homemade_pistol', rewardCount: 1,
    extraRewards: [{ defId: 'ammo_9mm', count: 6 }],
    relationDelta: 8, xpReward: 60, moneyReward: 0,
  },
  {
