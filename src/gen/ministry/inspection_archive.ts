...
const NINA_DEF: PlotNpcDef = {
  ...
  talkLinesPost: [
    ...
    'Архив отметил вас карандашом. Карандаш стирается хуже крови.',
...
const EVSEY_DEF: PlotNpcDef = {
  ...
  talkLines: [
    'Не трогайте верхний ящик. Он помнит пальцы поштучно.',
  ...
  talkLinesPost: [
    'Доносы подшиты. Полка перестала шептать фамилии.',
...
const MARFA_DEF: PlotNpcDef = {
  ...
  talkLinesPost: [
    'Жалобы есть. Теперь у моего страха входящий номер.',
    'Берите талон. Он мокрый, но очередь любит мокрые доказательства.',
    'Я постою ещё немного. Вдруг окно вспомнит, что оно окно.',
  ],
};
