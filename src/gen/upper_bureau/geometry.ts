...
export const UPPER_BUREAU_EVENT_BASE_TAGS = ['upper_bureau', 'bureaucracy', 'documents'] as const;

export interface UpperBureauDistrictSpec {
  name: string;
...
export interface UpperBureauHqSpec {
  owner: TerritoryOwner;
  hqName: string;
  x: number;
  y: number;
...
export interface UpperBureauTerritoryProfile {
  owner: TerritoryOwner;
  targetShare: number;
  spread: number;
...
export const UPPER_BUREAU_DISTRICTS: readonly UpperBureauDistrictSpec[] = [
  {
...
export const UPPER_BUREAU_HQ_SPECS: readonly UpperBureauHqSpec[] = [
  {
    owner: ZoneFaction.CITIZEN,
...
export const UPPER_BUREAU_TERRITORY_PROFILES: readonly UpperBureauTerritoryProfile[] = [
  {
    owner: ZoneFaction.CITIZEN,
    targetShare: 0.42,
    spread: 1.34,
...
export function upperBureauQuestTags(...tags: string[]): string[] {
  return [...UPPER_BUREAU_EVENT_BASE_TAGS, ...tags].slice(0, 8);
}

export function upperBureauQuestData(action: string, extra?: Record<string, unknown>): Record<string, unknown> {
  return {
    routeId: UPPER_BUREAU_ROUTE_ID,
...
export const ISKRA_DEF: PlotNpcDef = {
  name: 'Мадам Искра',
  isFemale: true,
...
export const LEV_DEF: PlotNpcDef = {
  name: 'Аудитор Лев',
  isFemale: false,
...
export const TOLIK_DEF: PlotNpcDef = {
  name: 'Толик Чистый',
  isFemale: false,
  faction: Faction.CITIZEN,
...
export const ANNA_DEF: PlotNpcDef = {
...
export const TOLL_KEEPER_DEF: PlotNpcDef = {
...
export const AMBUSH_DEF: PlotNpcDef = {
...
export function stampBureauRoom(
  world: World,
  id: number,
  type: RoomType,
  name: string,
...
export function addGatePartition(
  world: World,
  x: number,
  y0: number,
  y1: number,
...
export function addBureauContainer(
  world: World,
  room: Room,
  x: number,
  y: number,
...
export function decorateSalon(world: World, room: Room): void {
...
export function decorateOffice(world: World, room: Room): void {
...
export function decorateFileRoom(world: World, room: Room): void {
...
export function decorateCleanerRoom(world: World, room: Room): void {
...
export function carveBureauCell(world: World, x: number, y: number, floorTex: Tex, roomId = -1): void {
  const ci = world.idx(x, y);
...
export function carveBureauRect(world: World, x: number, y: number, w: number, h: number, floorTex: Tex, roomId = -1): void {
  for (let dy = 0; dy < h; dy++) {
    for (let dx = 0; dx < w; dx++) carveBureauCell(world, x + dx, y + dy, floorTex, roomId);
  }
}

export function carveBureauLine(world: World, ax: number, ay: number, bx: number, by: number, width: number, floorTex: Tex): void {
...
export function carveRibbonLine(world: World, ax: number, ay: number, bx: number, by: number, width: number, fieldTex: Tex, ribbonTex: Tex): void {
  carveBureauLine(world, ax, ay, bx, by, width, fieldTex);
  carveBureauLine(world, ax, ay, bx, by, Math.max(1, width - 3), ribbonTex);
}

export function stampExpansionRoom(
  world: World,
  type: RoomType,
  name: string,
  x: number,
...
export function sealExpansionRoomPerimeter(world: World, room: Room): void {
...
export function sealUpperBureauRouteCutRooms(world: World): void {
  for (const name of [
...
export function addHorizontalGatePartition(
  world: World,
  y: number,
  x0: number,
  x1: number,
...
export function placeFeatureRow(world: World, ax: number, ay: number, bx: number, by: number, step: number, feature: Feature): void {
...
export function decorateClerkCage(world: World, room: Room): void {
...
export function decorateArchiveBalcony(world: World, x0: number, y0: number, x1: number, y1: number): void {
...
export function addPublicQueueTier(world: World, rng: () => number): void {
...
export function addPrivateOfficeTier(world: World, rng: () => number): void {
...
export function addArchiveBalconyTier(world: World): void {
...
export function addStaffBalconyTier(world: World): void {
...
export function addServiceTier(world: World, rng: () => number): void {
...
export function bureauRoomPitch(spec: UpperBureauDistrictSpec): { x: number; y: number } {
  return { x: spec.roomW + 5, y: spec.roomH + 7 };
}

export function bureauDistrictSpine(spec: UpperBureauDistrictSpec): { x: number; y0: number; y1: number } {
...
export function addBureauMicroDistrict(world: World, spec: UpperBureauDistrictSpec): void {
  const pitch = bureauRoomPitch(spec);
...
export function addMiniHqCluster(world: World, spec: UpperBureauHqSpec): void {
...
export function setAdministrativeZones(world: World): void {
  generateZones(world);
  retuneUpperBureauZones(world);
}

export interface UpperBureauZoneLevelMark {
  x: number;
  y: number;
  level: number;
}

export const UPPER_BUREAU_TERRITORY_BUCKET_SIZE = 32;
export const UPPER_BUREAU_TERRITORY_BUCKET_SIDE = W / UPPER_BUREAU_TERRITORY_BUCKET_SIZE;

export const UPPER_BUREAU_ZONE_LEVEL_MARKS: readonly UpperBureauZoneLevelMark[] = [
  { x: 260, y: 508, level: 3 },
  { x: 356, y: 476, level: 3 },
  { x: 444, y: 508, level: 4 },
  { x: 468, y: 508, level: 4 },
...
export const UPPER_BUREAU_SAMOSBOR_ZONE_MARKS: readonly { x: number; y: number }[] = [
  { x: 724, y: 540 },
  { x: 760, y: 635 },
  { x: 840, y: 616 },
];

export function upperBureauBaselineZoneLevel(world: World, x: number, y: number): number {
...
export function applyUpperBureauZoneLevelMark(world: World, mark: UpperBureauZoneLevelMark): void {
  const zone = world.zones[world.zoneMap[world.idx(mark.x, mark.y)]];
  if (!zone) return;
  zone.level = Math.max(zone.level, mark.level);
}

export function upperBureauHash01(a: number, b: number, c: number): number {
...
export function upperBureauRoomOwnerHint(room: Room | undefined): TerritoryOwner | undefined {
...
export function upperBureauRoomBias(room: Room | undefined, owner: TerritoryOwner): number {
  if (!room) return 0;
...
export function upperBureauOwnerScore(world: World, x: number, y: number, profile: UpperBureauTerritoryProfile, room: Room | undefined): number {
...
export function paintUpperBureauTargetTerritory(world: World): void {
...
export function paintUpperBureauRoomTerritory(world: World, room: Room, owner: TerritoryOwner): void {
  for (let dy = 0; dy < room.h; dy++) {
    for (let dx = 0; dx < room.w; dx++) setTerritoryOwnerAtIndex(world, world.idx(room.x + dx, room.y + dy), owner);
  }
}

export function paintUpperBureauHqTerritory(world: World): void {
...
export function applyUpperBureauSamosborZoneOverlay(world: World): void {
...
export function carveUpperBureauCorridors(world: World): void {
...
export function addUpperBureauDoorsAndLifts(world: World, rooms: UpperBureauRooms): void {
...
export function decorateUpperBureauRooms(world: World, rooms: UpperBureauRooms): void {
...
export function addUpperBureauItems(entities: Entity[], nextId: NextId, rooms: UpperBureauRooms): void {
...
export function addUpperBureauContainers(world: World, rooms: UpperBureauRooms, ids: NpcIds): void {
...
export function finalizeUpperBureauFloor(world: World, salon: Room): void {
  for (const room of world.rooms) {
    if (!room) continue;
