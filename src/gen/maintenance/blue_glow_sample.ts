...
const BUYER_DEF: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'Принесете герметичный образец — оплачу как научный реагент, без сказок про вечные батареи.',
  ],
  talkLinesPost: [
...
registerSideQuest('ag68_blue_sample_cleaner', CLEANER_DEF, [{
  ...
  type: QuestType.FETCH,
  desc: 'Глушитель: «Принеси синий образец в герме. Уничтожим по акту, без героизма и светящихся карманов.»',
  targetItem: BLUE_GLOW_SAMPLE_SEALED, targetCount: 1,
