...
const SASHA_DEF: PlotNpcDef = {
  ...
  talkLinesPost: [
    'Маршрут держится. Не навсегда, но лифт хотя бы снова слушает кнопку.',
...
const GUARD_DEF: PlotNpcDef = {
  ...
  talkLinesPost: [
    'Трос чистый. Охрана запишет это как дисциплину, а не как чудо.',
...
registerSideQuest('ag50_shaft_sasha', SASHA_DEF, [
  {
    ...
    desc: 'Саша: «Проверь шахту N-089 {dir}. Если трос целый, будем чинить маршрут, а не хоронить кабину.»',
  ...
  },
  {
    ...
    desc: 'Саша: «Три предохранителя в щиток N-089. После этого лифт хотя бы перестанет выбирать этаж по запаху.»',
