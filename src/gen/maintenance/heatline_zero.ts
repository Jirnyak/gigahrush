...
const ZAKHAR_DEF: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'Манометр, асбестовый шнур и герметик — это ремонт. Шнур с герметиком без стрелки — это рискованный сброс.',
  ],
  talkLinesPost: [
...
const MIRA_DEF: PlotNpcDef = {
  ...
  talkLines: [
    'Я веду обход. Не героический, просто там меньше пара.',
    ...
    'Если полезешь к вентилю без деталей, не стой лицом к лампе.',
  ],
  talkLinesPost: [
...
registerSideQuest('ag14_zakhar_nulevoy', ZAKHAR_DEF, [
  ...
  },
  {
    ...
    giverNpcId: 'ag14_zakhar_nulevoy',
    type: QuestType.FETCH,
    desc: 'Захар: «Нужен манометр. Без стрелки мы не знаем, это ремонт или последняя экскурсия.»',
...
registerSideQuest('ag14_mira_obvodnaya', MIRA_DEF, [
  {
    ...
    desc: 'Мира: «Проверь безопасный душевой обход {dir}. Если вода еще есть, обваренный коридор можно не героизировать.»',
