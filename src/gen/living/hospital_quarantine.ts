...
const NPC_DEFS: Record<string, PlotNpcDef> = {
  ...
  ag17_yura_patient: {
    ...
    talkLines: [
      ...
      'Санитар считает нас по койкам. Койки считают обратно.',
    ],
    talkLinesPost: [
  ...
  ag17_taras_sanitar: {
    ...
    talkLines: [
      'Карантинный пост держит дверь, пока дверь не вспомнит, что она коридор.',
      'Внутри ходит бывший пациент. Уже без очереди.',
      'Уберите мертвяка - выдам санитарный набор. Не геройствуйте без выхода.',
      'Открыли створку - закрывайте за собой. Туман любит вежливых.',
    ],
    talkLinesPost: [
  ...
  ag17_varvara_morgue: {
    ...
    talkLinesPost: [
      ...
      'Не читайте оборот карты вслух. Там фамилии еще слушают.',
    ],
  },
};
