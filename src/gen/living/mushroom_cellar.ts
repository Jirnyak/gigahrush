...
const NPC_DEFS: Record<string, PlotNpcDef> = {
  ag12_egor_plesen: {
    ...
    talkLines: [
      'Тише у стеллажей. Гриб любит, когда его считают пищей, а не чудом.',
    ...
    talkQuestResponse: 'Валера услышал? Хорошо. Когда тайник стыдится, из него иногда выпадает паек.',
  },
