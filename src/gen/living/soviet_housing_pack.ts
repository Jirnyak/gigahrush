...
const NPC_DEFS: Record<string, PlotNpcDef> = {
  ag03_pasha_concierge: {
    ...
    talkLines: [
      'Записывайся в журнал. Даже если тебя уже записали до рождения.',
      'Консьержная держится, потому что я не сплю. Сон тут сразу становится пропуском для чужих.',
      'После сирены не стой у стекла. Стекла нет, но привычка у тумана осталась.',
    ...
    talkQuestResponse: 'Повариха опять жалуется? Передай ей: если дверь не хлопает, значит дом еще жив.',
  },
  ...
  ag03_gleb_radio: {
    ...
    talkLines: [
      'Тише. Несущая стена сейчас передает цифры. Она делает вид, что это помехи.',
      ...
      'Если услышишь в эфире свой адрес, не отвечай. Адреса тут охотятся стаями.',
      'Я паял антенну из ложек. Ложки начали принимать обеденное меню на завтра.',
    ],
    talkLinesPost: [
      'Частота стала чище. Теперь шепчет только бетон, без глаза.',
      'Энергоячейка держит сигнал. Плохо то, что сигнал держит нас.',
      'Передам, если эфир назовет твою комнату.',
    ],
  },
  ...
  ag03_rita_lostfound: {
    ...
    talkLines: [
      ...
      'Вчера принесли левый ботинок. Сегодня он попросил вернуть ему правого жильца.',
      'Еда исчезает быстрее заявлений. Принеси хлеба и консерву, я выдам честную компенсацию.',
      'Не трогай красный шкаф. Там лежат вещи тех, кто еще не потерялся.',
      'Если найдешь предмет со своим именем, оставь его мне. Это не подарок.',
      'Семен из ремонтной опять утащил мой ящик с бирками. Говорит, гермодвери тоже теряются.',
    ],
    talkLinesPost: [
      'Полки сыты. Вещи сегодня молчат.',
      'За хлеб спасибо. Я не спрашиваю, чей он был.',
      'Если что-то потеряешь, приходи сразу. Пока оно не нашло тебя первым.',
    ],
  },
  ...
  ag03_semen_hermo: {
    ...
    talkLines: [
      ...
      'Мне нужны бинты и таблетки. Не для людей. Для пальцев, которые дверь забрала на проверке.',
      'Рита думает, я ворую бирки. Бирки сами липнут к сломанным дверям.',
      'Слышишь хлопок без двери? Значит, где-то закрыли комнату, которой нет.',
      'Я чиню железо, а оно чинит меня обратно. Поэтому хожу медленно.',
      'Во время самосбора не стой в ремонтном коридоре. Он первый вспоминает, что он коридор.',
    ],
    talkLinesPost: [
      'Медицина помогла. Теперь руки дрожат по расписанию.',
      'Если дверь шепчет твоим голосом, бей по петлям.',
  ...
  ag03_tamara_kitchen: {
    ...
    talkLines: [
      ...
      'Каша нормальная. Если смотрит на тебя, смотри первым.',
      'Сходи к Паше и скажи, чтобы перестал хлопать дверью. От этого суп сворачивается в карту.',
      'Тут кто-то опрокинул табурет и ушел в стену. Я записала это как прогул.',
      'Когда сирена воет, кухня остается кухней. Только коридор снаружи становится чужим.',
      'Не бери нож с раковины. Он уже выбрал повара.',
    ],
    talkLinesPost: [
      'Паша услышал? Хорошо. Значит, завтра суп не будет считать жильцов.',
      'Компот держи крепче. В нем отражается не тот этаж.',
      'Если кастрюля опять начнет спорить, я позову ликвидаторов.',
    ],
  },
  ...
  ag03_kirill_runner: {
    ...
    talkLines: [
      ...
      'Глеб просил не трогать приемник. Я тронул. Теперь он знает мой день рождения.',
      ...
      'На кухне пятно похоже на карту. Я видел там наш блок, только без выхода.',
    ],
    talkLinesPost: [
...
registerSideQuest('ag03_rita_lostfound', NPC_DEFS.ag03_rita_lostfound, [
  {
    ...
    type: QuestType.FETCH,
    desc: 'Рита Находкина: «Принеси хлеб и консерву. Потерянные вещи сегодня требуют паек.»',
...
registerSideQuest('ag03_semen_hermo', NPC_DEFS.ag03_semen_hermo, [
  {
    ...
    type: QuestType.FETCH,
    desc: 'Семен Гермошов: «Бинт и таблетки. Дверь прикусила руку, а я прикусил мат.»',
...
registerSideQuest('ag03_tamara_kitchen', NPC_DEFS.ag03_tamara_kitchen, [
  {
    ...
    type: QuestType.TALK,
    desc: 'Тамара Кипяток: «Скажи Паше, чтобы не хлопал дверью. Суп пугается.»',
  ...
  },
  {
    ...
    desc: 'Тамара Кипяток: «Зайди на общую кухню и посмотри, почему пятно на полу стало похоже на карту.»',
