...
const NPC_DEF: PlotNpcDef = {
  ...
  talkLines: [
    'Тише, клиент. На Толкучке стены слушают лучше участкового.',
  ...
  talkLinesPost: [
    'Нормально занёс. Шурик любит людей с памятью и боезапасом.',
...
registerSideQuest('shurik_baryga', NPC_DEF, [
  {
    ...
    desc: 'Шурик: «Занеси десять патронов 9мм. Получишь обрез, шесть дробовых и две сигареты на отходняк. Прилавок свидетелей не любит.»',
