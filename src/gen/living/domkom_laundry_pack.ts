...
const NPC_DEFS: Record<string, PlotNpcDef> = {
  ag03r2_zoya_laundry: {
    ...
    talkLines: [
      ...
      'Чужое белье не бери. Карманы помнят руки лучше людей.',
      'Домком говорит закрываться у них. Домком не слышал, как стиральная машина зовет по имени.',
    ],
    talkLinesPost: [
  ...
  ag03r2_lev_signal: {
    ...
    talkLines: [
      ...
      'Предохранители выбивает, когда туман еще только думает.',
      ...
      'Если детектор пискнул возле сухого пола, значит пол просто хорошо притворяется.',
    ],
    talkLinesPost: [
      'Сигнал ровнее. Плохие новости теперь приходят без кашля.',
      'Лампы моргнули три раза. Это не просьба, это счет.',
      'Держи ухо ниже гордости.',
    ],
  },
  ...
  ag03r2_nina_domkom: {
    ...
    talkLinesPost: [
      ...
      'Дом держится не на бетоне, а на списках. Бетон только подделывает подпись.',
    ],
  },
  ...
  ag03r2_arsen_gasket: {
    ...
    talkLines: [
      'Хорошая дверь не обещает спасения. Она просто молчит, пока держит.',
      ...
      'Слышу шаги за закрытой дверью. Это нормально. Ненормально, когда они считают.',
    ],
    talkLinesPost: [
