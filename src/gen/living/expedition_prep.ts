...
const NPC_DEFS: Record<string, PlotNpcDef> = {
  ...
  [REPAIR_ID]: {
    ...
    talkLines: [
      ...
      'Нужен гермоуплотнитель. Один хороший шов превращает комнату из надежды в укрытие.',
    ...
    talkLinesPost: [
      'Один шов держит. Не весь блок, но один угол теперь можно переждать без молитвы.',
  ...
  [LOST_ID]: {
    ...
    talkLines: [
      ...
      'Если после вылазки вещь стала твоей, но шепчет чужим голосом, не храни ее у кровати.',
    ],
    talkLinesPost: [
      'Бирка вернулась. Шкаф перестал стучать изнутри, это уже прогресс.',
      'Карта твоя. Красные кресты на ней не клад, а места, где лучше считать патроны.',
      'Потерял что-то после лифта - приходи быстро. Дом любит оформлять находки на себя.',
    ],
  },
  ...
  [WITNESS_ID]: {
    ...
    talkLinesPost: [
      ...
      'Люди читают короткое: вода опасна, трубы слушают, один бинт мало. Этого достаточно.',
