...
const NPC_DEF: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'Хлеб наш насущный даждь нам днесь. В хруще это и молитва, и список покупок.',
    'Христос Воскресе! Воистину Воскресе! Тише, за стеной кто-то отвечает не тем голосом.',
    'Свечи горят ровно — значит, коридор ещё держится. Если пламя легло на бок, уходи.',
    'У святой воды срок годности один самосбор. Дальше это уже просто мутная вода с надеждой.',
    'Не бейся лбом в герму, чадо. Сначала помолись, потом ищи запасной вентиль.',
  ],
  talkLinesPost: [
    'Да хранит тебя Господь, и пусть дом сегодня пройдёт мимо твоей двери.',
...
registerSideQuest('batushka', NPC_DEF, [
  {
    ...
    desc: 'Батюшка: «Принеси три пасхальных яйца, чадо. Одним похристосуемся, второе отдадим детям, третье оставим у гермы — для Троицы и техники безопасности.»',
