...
const TRAFFIC_MILITSIYA: PlotNpcDef = {
  ...
  talkLines: [
    ...
    'Светофор не сломан, он сомневается. Два предохранителя вернут ему мнение.',
    'На белые полосы наступай быстро. Черный асфальт тут слушает дольше, чем надо.',
  ],
  talkLinesPost: [
...
const ZEBRA_GRANNY: PlotNpcDef = {
  ...
  talkLinesPost: [
    ...
    'Белая полоса не святая. Просто на ней видно, кто бежит.',
  ],
};
