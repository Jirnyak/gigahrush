 ...
 *
 * Случайность идет через общий `rng()`, как и у остальных настольных игр: ставка
 * уходит в деньги игрока, поэтому расстановка и выбор залпа обязаны быть
 * детерминированными от сида — иначе сейв-скам переигрывает партию, а хост и пир
 * в онлайне расходятся в исходе. Обе функции принимают явный источник — тесты
 * гоняют их на своем сиде.
 */
