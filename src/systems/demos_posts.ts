...
// Ключи — маршрутные координаты (раньше здесь лежали коды снятого FloorLevel и
// лента всегда печатала «этот этаж»). Формулировки цензурные и намеренные:
// низ Демос называет уклончиво.
