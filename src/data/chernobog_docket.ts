...
export const CHERNOBOG_DOCKET_ITEMS: Record<string, ItemDef> = {
  chernobog_cell_map: {
    ...
    type: ItemType.MISC,
    desc: 'Карта центральной и внешней ячеек. Пустые адреса отмечены как занятые страхом.',
    spawnRooms: [],
    spawnW: 0,
    value: 180,
  },
  ...
  chernobog_confiscation_act: {
    ...
    type: ItemType.MISC,
    desc: 'Изъят предмет: знак, ладонь, повод. Свидетель выведен в приложение.',
    spawnRooms: [],
    spawnW: 0,
    value: 150,
  },
...
export const CHERNOBOG_DOCKET_NOTES = [
  'Форма ЧБ-0: центральная ячейка не установлена. Внешние адреса просят не смотреть на них после отбоя.',
  ...
  'Индекс внешней ячейки хранить сухо. При намокании фамилии переходят в графу "свидетель".',
] as const;
