...
export const ITEMS: Record<string, ItemDef> = {
  ...
  antifungal_ointment:{ id:'antifungal_ointment', name:'Противогрибковая мазь', type:ItemType.MEDICINE, desc:'Жирная мазь от грибкового зуда и спор на коже. Лечит мало, но помогает дотянуть до медпункта.', spawnRooms:[RoomType.MEDICAL,RoomType.BATHROOM], spawnW:1, value:55, tags:['medicine','fungus'], use:medicine(20) },
