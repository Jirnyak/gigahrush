 ...
 *
 * Сетка та же, что у фаст-тревела (`gen/fast_elevators.ts`): 4×4 ячейки шагом
 * 256 клеток. В каждой ячейке ровно одна шахта, поэтому «до ближайшей шахты не
 * дальше половины ячейки» верно всегда. Точка внутри ячейки гуляет по сиду ПАРЫ
 * этажей: соседние этажи связаны, но два разных перегона не похожи друг на друга.
 */
...
/** Сторона сетки шахт. Совпадает с сеткой фаст-тревела не случайно: кабина
 *  быстрого перемещения и маршрутная шахта — одна и та же вертикаль здания. */
