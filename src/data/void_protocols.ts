...
export const VOID_PROTOCOLS: readonly VoidProtocolDef[] = [
  {
    ...
    costLine: 'Цена: стабилизатор и энергоячейки выдаются сразу; двери и ПСИ берут проценты.',
  ...
  },
  {
    ...
    ruleLine: 'Правило: ПСИ-сброс гасит агрессию рядом, но проходит через игрока.',
