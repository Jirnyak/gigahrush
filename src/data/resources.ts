...
export const RESOURCES: ResourceDef[] = [
  { id: 'drink_water', name: 'Питьевая вода', baseStock: 120, lowStock: 35, scarcityMax: 2.7, pricePressureMax: 3.2, rewardPressureMax: 2.3, roomTypes: [RoomType.KITCHEN, RoomType.STORAGE, RoomType.MEDICAL, RoomType.BAR, RoomType.SHOP], itemIds: ['water', 'tea', 'kompot', 'filtered_water', 'boiler_water', 'metal_water', 'instant_coffee', 'siren_energy', 'calm_brew', 'water_reservoir_sample', 'water_reservoir_quota'] },
  { id: 'food', name: 'Еда', baseStock: 140, lowStock: 40, scarcityMax: 2.6, pricePressureMax: 3.1, rewardPressureMax: 2.2, roomTypes: [RoomType.KITCHEN, RoomType.STORAGE, RoomType.SHOP, RoomType.MARKET, RoomType.BAR], itemIds: ['bread', 'canned', 'kasha', 'rawmeat', 'mushroom_mass', 'infected_mushroom', 'grey_briquette', 'green_briquette', 'liquidator_ration', 'red_concentrate', 'experimental_concentrate', 'protein_mold_cake', 'pearl_barley', 'soup_cube', 'pressed_sugar', 'yeast_bread'] },
  ...
  { id: 'tools', name: 'Инструменты', baseStock: 55, lowStock: 12, roomTypes: [RoomType.PRODUCTION, RoomType.STORAGE, RoomType.SHOP], itemIds: ['flashlight', 'lighter', 'uv_spotlight', 'smoke_candle_check', 'door_kit', 'block_kit', 'cleaning_kit', 'slime_scraper', 'vacuum', 'chalk', 'radio', 'radio_headset_liquidator', 'fog_detector', 'unpeople_detector', 'duct_tape', 'fuse', 'manometer', 'valve_tag', 'inspection_mirror', 'sealant_tube', 'hermetic_tape', 'asbestos_cord', 'gasmask_filter', 'ozk_patch', 'ip4_gasmask', 'protective_apron', 'hermo_gasket', 'rubber_door_wedge', 'wire_coil', 'filter_layer', 'alkali_powder', 'lime_bucket', 'liquidator_rake', 'rubber_club', 'cleanup_tongs', 'filter_canister', 'wet_rag_bundle', 'decon_fluid', 'portable_siren_key'] },
