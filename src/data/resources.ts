...
export const RESOURCES: ResourceDef[] = [
  ...
  { id: 'tools', name: 'Инструменты', baseStock: 55, lowStock: 12, roomTypes: [RoomType.PRODUCTION, RoomType.STORAGE], itemIds: ['flashlight', 'lighter', 'uv_spotlight', 'smoke_candle_check', 'door_kit', 'block_kit', 'cleaning_kit', 'slime_scraper', 'vacuum', 'chalk', 'radio', 'radio_headset_liquidator', 'fog_detector', 'unpeople_detector', 'duct_tape', 'fuse', 'manometer', 'valve_tag', 'inspection_mirror', 'sealant_tube', 'hermetic_tape', 'asbestos_cord', 'gasmask_filter', 'ozk_patch', 'ip4_gasmask', 'protective_apron', 'hermo_gasket', 'rubber_door_wedge', 'wire_coil', 'filter_layer', 'alkali_powder', 'lime_bucket', 'liquidator_rake', 'rubber_club', 'cleanup_tongs', 'filter_canister', 'wet_rag_bundle', 'decon_fluid', 'portable_siren_key'] },
