...
export const RESOURCES: ResourceDef[] = [
  ...
  { id: 'tools', name: 'Инструменты', baseStock: 55, lowStock: 12, roomTypes: [RoomType.PRODUCTION, RoomType.STORAGE], itemIds: ['flashlight', 'uv_spotlight', 'door_kit', 'block_kit', 'cleaning_kit', 'vacuum', 'chalk', 'radio', 'fog_detector', 'unpeople_detector', 'duct_tape', 'fuse', 'manometer', 'valve_tag', 'inspection_mirror', 'sealant_tube', 'gasmask_filter', 'hermo_gasket', 'wire_coil', 'filter_layer'] },
