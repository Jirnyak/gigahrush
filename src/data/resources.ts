...
export const RESOURCES: ResourceDef[] = [
  ...
  { id: 'electronics', name: 'Электроника', baseStock: 35, lowStock: 8, roomTypes: [RoomType.PRODUCTION, RoomType.STORAGE, RoomType.OFFICE], itemIds: ['ammo_energy', 'flashlight', 'uv_spotlight', 'radio', 'radio_headset_liquidator', 'field_radio_battery', 'fog_detector', 'unpeople_detector', 'circuit_board', 'fuse', 'relay_diagram', 'lamp_bulb'] },
