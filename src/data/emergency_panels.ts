...
export const EMERGENCY_PANEL_DEFS: readonly EmergencyPanelDef[] = [
  {
    ...
    color: '#f6d66a',
    weight: 34,
    geometryWeights: { service_spines: 3.2, workshops: 2.8, collectors: 1.4 },
  ...
  },
  {
    ...
    color: '#79c8ff',
    weight: 30,
    geometryWeights: { collectors: 3.4, workshops: 1.8, service_spines: 1.5 },
  ...
  },
  {
    ...
    color: '#9ee6c4',
    weight: 28,
    geometryWeights: { service_spines: 3.0, collectors: 2.1, workshops: 1.7 },
