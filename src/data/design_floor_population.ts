...
const DESIGN_FLOOR_POPULATION_OVERRIDES: Readonly<Record<DesignFloorId, DesignFloorPopulationOverride>> = {
  ...
  cantor_pustoty: {
    ...
    monsterPlacement: {
      ...
      roomWeights: {
        [RoomType.CORRIDOR]: 1.42,
        [RoomType.STORAGE]: 1.34,
        [RoomType.PRODUCTION]: 1.12,
        [RoomType.COMMON]: 0.82,
      },
      zoneWeights: {
        [ZoneFaction.SAMOSBOR]: 1.52,
        [ZoneFaction.CULTIST]: 1.1,
        [ZoneFaction.WILD]: 0.92,
        [ZoneFaction.LIQUIDATOR]: 0.34,
        [ZoneFaction.CITIZEN]: 0.2,
      },
      anchors: [
        { x: 512, y: 512, radius: 118, weight: 0.72 },
        { x: 188, y: 188, radius: 140, weight: 1.52 },
        { x: 836, y: 836, radius: 150, weight: 1.72 },
        { x: 836, y: 188, radius: 132, weight: 1.58 },
        { x: 188, y: 836, radius: 132, weight: 1.48 },
        { x: 512, y: 122, radius: 126, weight: 1.35 },
      ],
      bucketSize: 22,
      maxPerBucket: 8,
    },
