...
export const SLIME_DEFS: readonly SlimeDef[] = [
  {
    ...
    tags: ['slime', 'sample', 'residue', 'odor', 'cleanup', 'civilian'],
    danger: 1,
    cleanupHint: 'Респиратор, обход или сжечь пятно до заселения комнаты.',
  ...
  },
  {
    id: 'slime_green',
    name: 'Зелёная слизь',
    tags: ['slime', 'sample', 'residue', 'acid', 'organic_damage', 'science'],
    danger: 3,
    cleanupHint: 'Держать дистанцию, брать щипцами, нейтрализовать щёлочью.',
  ...
  },
  {
    id: 'slime_white',
    name: 'Белая слизь',
    tags: ['slime', 'sample', 'residue', 'psi', 'compulsion', 'npc_risk'],
    danger: 4,
    cleanupHint: 'Не смотреть долго, закрыть источник и вывести свидетелей.',
  ...
  },
  {
    id: 'slime_black',
    name: 'Чёрная слизь',
    tags: ['slime', 'sample', 'residue', 'spawn_risk', 'cult', 'uv'],
    danger: 4,
    cleanupHint: 'Герметизировать, светить УФ или жечь; культ рядом не оставлять.',
  ...
  },
  {
    ...
    danger: 3,
    cleanupHint: 'Экранировать контейнером и не носить рядом с лампами.',
  ...
  {
    id: 'slime_silver',
    name: 'Серебристая слизь',
    tags: ['slime', 'sample', 'residue', 'temptation', 'relief', 'contraband'],
    danger: 5,
    cleanupHint: 'Не пробовать, не вскрывать, сдавать только запечатанной.',
  ...
  },
  {
    ...
    danger: 5,
    cleanupHint: 'Не смотреть на перелив, закрыть метки и работать по памяти.',
