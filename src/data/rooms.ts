...
export const ROOM_DEFS: Record<RoomType, RoomDef> = {
  ...
  [RoomType.SHOP]:       { type: RoomType.SHOP,       name: 'Лавка',        minW:3, maxW:6,  minH:3, maxH:5,  wallTex: Tex.PANEL,     floorTex: Tex.F_LINO },
  [RoomType.BAR]:        { type: RoomType.BAR,        name: 'Бар',          minW:5, maxW:9,  minH:4, maxH:7,  wallTex: Tex.PANEL,     floorTex: Tex.F_WOOD },
  [RoomType.MARKET]:     { type: RoomType.MARKET,     name: 'Торговый ряд', minW:8, maxW:16, minH:6, maxH:12, wallTex: Tex.CONCRETE,  floorTex: Tex.F_CONCRETE },
};
