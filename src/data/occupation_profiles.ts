...
export const OCCUPATION_PROFILES: Readonly<Record<Occupation, OccupationProfile>> = {
  ...
  [Occupation.STOREKEEPER]: p({
    ...
    workRoomTypes: [RoomType.STORAGE, RoomType.SHOP, RoomType.MARKET],
    workRoomWeights: { [RoomType.STORAGE]: 34, [RoomType.SHOP]: 30, [RoomType.MARKET]: 26, [RoomType.PRODUCTION]: 8 },
    defaultGenerationWeight: 10,
    workDrive: 0.72,
    karmaOffset: 0,
    kitchenFoodRestore: 3.5,
  ...
  [Occupation.ALCOHOLIC]: p({
    ...
    workRoomTypes: [RoomType.BAR, RoomType.SMOKING, RoomType.COMMON, RoomType.KITCHEN],
    workRoomWeights: { [RoomType.BAR]: 30, [RoomType.SMOKING]: 24, [RoomType.COMMON]: 15, [RoomType.KITCHEN]: 15 },
    defaultGenerationWeight: 5,
    workDrive: 0.35,
    duty: 0.22,
    sociability: 0.72,
  ...
  [Occupation.PERFORMER]: p({
    ...
    workRoomTypes: [RoomType.COMMON, RoomType.BAR, RoomType.SMOKING, RoomType.LIVING],
    workRoomWeights: { [RoomType.COMMON]: 26, [RoomType.BAR]: 22, [RoomType.SMOKING]: 18, [RoomType.LIVING]: 14, [RoomType.OFFICE]: 6 },
    defaultGenerationWeight: 1,
    workDrive: 0.62,
    duty: 0.42,
    sociability: 0.84,
