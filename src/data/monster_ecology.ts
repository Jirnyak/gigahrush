...
export const MONSTER_ECOLOGY: readonly MonsterEcologyDef[] = [
  ...
  },
  {
    ...
    rumorIds: ['monster_tumannik_strike_reveal', 'ecology_tumannik_strike_window'],
  ...
  },
  {
    ...
    role: 'Плотная стая слабых быстрых тел, которая давит открытую площадь числом.',
    cue: 'Черно-ржавая живая статика течет из щели, на полу остается темная крошка и желтые точки глаз.',
    rule: 'Тела слабые поодиночке и берут числом на открытом месте: в узком проходе стая теряет фланги, а огонь снимает сразу нескольких.',
    ...
    minSamosborCount: 2,
    rare: false,
    lootHint: 'черная хитиновая крошка, ржавые лапки, желтые глазки, редкая изолента из мусора',
    counterplay: 'Не принимайте стаю на открытом месте: держите узкий проход, выжигайте тела огнем, уводите их приманкой в сторону от маршрута или проскакивайте узел коротким рывком.',
    deathLogHint: 'Смерть от роя должна читать открытую площадь вместо узкого прохода, бой без огня или отход через саму стаю.',
  ...
  },
  {
    ...
    minSamosborCount: 4,
    rare: true,
    lootHint: 'жирный хитин, слипшийся кокон, редкая карантинная карта из воротника',
    ...
    deathLogHint: 'Смерть от мухожука должна читать брошенного раненого, потраченную впустую аптечку или добитого своего.',
