...
export const PHYS_WEAPON_STATS: Record<string, WeaponStats> = {
  ...
  grn420_gravizhernov:{ dmg: 170, durability: 0, range: 0, speed: 5.8, isRanged: true, ammoType: 'ammo_energy', projSpeed: 5.4, pellets: 1, spread: 0.012, projSprite: Spr.BFG_BOLT, projType: ProjType.BFG, aoeRadius: 7.2, soundId: 'bfg' },
  ...
  karkarov_pistol:{ dmg: 14, durability: 0, range: 0, speed: 0.48, isRanged: true, ammoType: 'ammo_9mm', projSpeed: 21, pellets: 1, spread: 0.035, projSprite: Spr.BULLET },
  zatychkin_pistol:{ dmg: 13, durability: 0, range: 0, speed: 0.18, isRanged: true, ammoType: 'ammo_9mm', projSpeed: 20, pellets: 1, spread: 0.08, projSprite: Spr.BULLET },
  slyoznev_pps41:{ dmg: 5, durability: 0, range: 0, speed: 0.055, isRanged: true, ammoType: 'ammo_9mm', projSpeed: 18, pellets: 1, spread: 0.19, projSprite: Spr.BULLET, soundId: 'ppsh' },
  eralashnikov_auto:{ dmg: 17, durability: 0, range: 0, speed: 0.12, isRanged: true, ammoType: 'ammo_762', projSpeed: 24, pellets: 1, spread: 0.11, projSprite: Spr.BULLET },
  nosin_rifle:{ dmg: 43, durability: 0, range: 0, speed: 1.45, isRanged: true, ammoType: 'ammo_762', projSpeed: 26, pellets: 1, spread: 0.018, projSprite: Spr.BULLET },
  moskvin_rifle:{ dmg: 62, durability: 0, range: 0, speed: 1.90, isRanged: true, ammoType: 'ammo_762', projSpeed: 29, pellets: 1, spread: 0.006, projSprite: Spr.BULLET },
  losyash_rifle:{ dmg: 118, durability: 0, range: 0, speed: 2.85, isRanged: true, ammoType: 'rifle_bolt_pack', projSpeed: 32, pellets: 1, spread: 0.002, projSprite: Spr.NAIL, soundId: 'nailgun' },
  ptrs_liquidator:{ dmg: 145, durability: 0, range: 0, speed: 4.25, isRanged: true, ammoType: 'ammo_harpoon', projSpeed: 34, pellets: 1, spread: 0.0015, projSprite: Spr.NAIL, soundId: 'nailgun' },
  tanev_svt40:{ dmg: 86, durability: 0, range: 0, speed: 2.55, isRanged: true, ammoType: 'ammo_762', projSpeed: 33, pellets: 1, spread: 0.002, projSprite: Spr.BULLET },
  ...
  chizh3_shotgun:{ dmg: 10, durability: 0, range: 0, speed: 1.0, isRanged: true, ammoType: 'ammo_shells', projSpeed: 17, pellets: 8, spread: 0.24, projSprite: Spr.PELLET, soundId: 'shotgun' },
  conscripts_doublebarrel:{ dmg: 7, durability: 0, range: 0, speed: 1.45, isRanged: true, ammoType: 'ammo_shells', projSpeed: 15, pellets: 7, spread: 0.28, projSprite: Spr.PELLET, soundId: 'shotgun' },
  rb91_auto_shotgun:{ dmg: 8, durability: 0, range: 0, speed: 0.65, isRanged: true, ammoType: 'ammo_shells', projSpeed: 16, pellets: 9, spread: 0.30, projSprite: Spr.PELLET, soundId: 'shotgun' },
  ...
  granit4u_belt_shotgun:{ dmg: 6, durability: 0, range: 0, speed: 2.35, isRanged: true, ammoType: 'ammo_shells', projSpeed: 14, pellets: 12, spread: 0.46, projSprite: Spr.PELLET, soundId: 'shotgun' },
  pushkin_shotgun:{ dmg: 11, durability: 0, range: 0, speed: 0.82, isRanged: true, ammoType: 'ammo_shells', projSpeed: 19, pellets: 6, spread: 0.12, projSprite: Spr.PELLET, soundId: 'shotgun' },
  rpl23_lmg:{ dmg: 11, durability: 0, range: 0, speed: 0.06, isRanged: true, ammoType: 'ammo_belt', projSpeed: 22, pellets: 1, spread: 0.17, projSprite: Spr.BULLET, soundId: 'machinegun' },
  p41_heavy_mg:{ dmg: 14, durability: 0, range: 0, speed: 0.045, isRanged: true, ammoType: 'ammo_belt', projSpeed: 21, pellets: 1, spread: 0.24, projSprite: Spr.BULLET, soundId: 'machinegun' },
  roks47_flamethrower:{ dmg: 5, durability: 0, range: 0, speed: 0.07, isRanged: true, ammoType: 'napalm_mix', projSpeed: 7, pellets: 2, spread: 0.22, projSprite: Spr.FLAME_BOLT, projType: ProjType.FLAME, soundId: 'flame' },
  agnia_a130:{ dmg: 2, durability: 0, range: 0, speed: 0.075, isRanged: true, ammoType: 'ammo_fuel', projSpeed: 8, pellets: 2, spread: 0.16, projSprite: Spr.FLAME_BOLT, projType: ProjType.FLAME, soundId: 'flame' },
  o15_multijet_flamer:{ dmg: 4, durability: 0, range: 0, speed: 0.18, isRanged: true, ammoType: 'napalm_mix', projSpeed: 7.5, pellets: 3, spread: 0.12, projSprite: Spr.FLAME_BOLT, projType: ProjType.FLAME, soundId: 'flame' },
  shmk_disposable:{ dmg: 8, durability: 0, range: 0, speed: 1.6, isRanged: true, ammoType: 'shmk_disposable', projSpeed: 6, pellets: 8, spread: 0.42, projSprite: Spr.FLAME_BOLT, projType: ProjType.FLAME, soundId: 'flame' },
