...
export const PHYS_WEAPON_STATS: Record<string, WeaponStats> = {
  ...
  brass_knuckles: { dmg: 14, durability: 80, range: 0.6, speed: 0.25, isRanged: false, knockback: 0.15 },
  ...
  ppsh:     { magazineSize: 71, reloadTime: 3.2, dmg: 8,  durability: 0,   range: 0,    speed: 0.07, isRanged: true, ammoType: 'ammo_9mm',      projSpeed: 18, pellets: 1, spread: 0.15,  projSprite: Spr.BULLET, soundId: 'ppsh' },
  shotgun:  { magazineSize: 6, reloadTime: 2.6, dmg: 12, durability: 0,   range: 0,    speed: 1.2,  isRanged: true, ammoType: 'ammo_shells',   projSpeed: 15, pellets: 7, spread: 0.34,  projSprite: Spr.PELLET, soundId: 'shotgun' },
  nailgun:  { magazineSize: 30, reloadTime: 1.8, dmg: 14, durability: 0,   range: 0,    speed: 0.33, isRanged: true, ammoType: 'ammo_nails',    projSpeed: 20, pellets: 1, spread: 0.014, projSprite: Spr.NAIL, soundId: 'nailgun' },
  ...
  machinegun:{ magazineSize: 100, reloadTime: 5.5, dmg: 13, durability: 0,  range: 0,    speed: 0.05, isRanged: true, ammoType: 'ammo_belt',     projSpeed: 21, pellets: 1, spread: 0.20,  projSprite: Spr.BULLET, soundId: 'machinegun' },
  grenade:  { magazineSize: 1, reloadTime: 0.8, dmg: 90, durability: 0,   range: 0,    speed: 1.9,  isRanged: true, ammoType: 'grenade',       projSpeed: 9,  pellets: 1, spread: 0,     projSprite: Spr.GRENADE, projType: ProjType.GRENADE, aoeRadius: 4.5, soundId: 'grenade' },
  gauss:    { magazineSize: 5, reloadTime: 3.0, dmg: 180, durability: 0,  range: 0,    speed: 2.6,  isRanged: true, ammoType: 'ammo_energy',   projSpeed: 44, pellets: 1, spread: 0,     projSprite: Spr.GAUSS_BOLT, soundId: 'gauss' },
  plasma:   { magazineSize: 24, reloadTime: 2.6, dmg: 26, durability: 0,   range: 0,    speed: 0.16, isRanged: true, ammoType: 'ammo_energy',   projSpeed: 14, pellets: 1, spread: 0.18,  projSprite: Spr.PLASMA_BOLT, soundId: 'plasma' },
  bfg:      { magazineSize: 1, reloadTime: 4.0, dmg: 270, durability: 0,  range: 0,    speed: 4.5,  isRanged: true, ammoType: 'ammo_energy',   projSpeed: 6.5, pellets: 1, spread: 0,    projSprite: Spr.BFG_BOLT, projType: ProjType.BFG, aoeRadius: 9, soundId: 'bfg' },
...
export const PHYS_WEAPON_ROLE_TIERS: Record<string, WeaponRoleTier> = {
  ...
  brass_knuckles: 'melee_emergency',
