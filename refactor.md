...
## 4. Критические регрессии после рефакторинга Z-координат (ТРЕБУЕТСЯ ИСПРАВЛЕНИЕ)
Последние коммиты по унификации Z-координат внесли сломы в генерацию и системы. Следующие пункты должны быть исправлены агентами (пошагово):
