...
>
> Это **живая веб-версия ГИГАХРУЩА**, она в руках у игроков и активно поддерживается:
> баги, UX, доводка систем. Работай здесь как обычно.
>
> Соседние проекты — не этот репозиторий: `gigahrush2` (будущий 3D-ремейк) и `тимаэрт`
> (другая игра). Не переноси сюда их решения и не уходи туда по своей инициативе.
> Полная версия баннера и проверенное состояние правила `Math.random()`: `AGENTS.md`,
> который здесь канонический.
...
> ⚠️ Token economy. Work to a tight token budget. Do not re-read files
