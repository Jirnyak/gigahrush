...
- **Координаты этажей.** Канон — числовой `z` из `DESIGN_FLOOR_ROUTES`: министерство 30, квартиры 14, жилой 0, коллекторы −26, ад −36, пустота −50. Старое шестиключевое пространство (60/100/140/180/200) и «представители» (2/-6/-14/-40) вычищены из констант, контрактов, слухов, экранов и самосбора, но встреченное в данных такое число почти наверняка означает непромигрированное место. Проверяй, а не копируй.
