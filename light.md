...
- `eyeLight(dist)` — мягкий постоянный приближённый свет у игрока (render-only,
  ...
  блики видны даже без снаряжённого фонарика: свет в руке зажигается ТОЛЬКО
  удержанием кнопки, поэтому `uFlashlight` равен нулю, пока игрок её не зажал.
  Пассивный ярус («горит сам, пока держишь») СНЯТ 2026-09-10 — он был написан
  целиком и не включён ни у одного предмета
