...
Этот файл не заменяет `desdoc.md`. `desdoc.md` остается широким roadmap и пулом идей. Здесь собраны десять отдельных expansion-направлений и один обязательный foundation-layer, каждый оформлен как технический дизайн-документ с игровым циклом, системами, интеграцией, производительностью, рисками и Definition of Done.
