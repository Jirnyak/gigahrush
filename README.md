...
| 17 | Пустота (без дающего) | FETCH | Проверить бутилированный голос | PSI-стабилизатор |
| 18 | Пустота (без дающего) | KILL | Ликвидировать Творца в Пустоте | Пустотный шип, святая вода |
| 19 | Пустота (без дающего) | FETCH | Сдать пустотный шип на месте перед возвращением | Святая вода, бинты, антидепрессант |
...
- **Живность заводится сама**: Мухи слетаются на кровь, тараканы держатся плит и сортиров, мошка кружит у ламп, пауки сидят в углах, где давно никто не ходил. Никто их не расставляет — они рождаются из того, что происходит в комнате, и разбегаются, когда подходишь. Столб мух через полкоридора значит ровно то, что ты подумал. В графических настройках есть переключатель, если хочется тишины.
