 ...
 *   - `armor_tok200` 18 000 — узкий костюм средней ступени, в полосе E2 между
 *     лёгкой (12 000) и средней (20 000);
 *   - `armor_ozk` 11 000 — ПЕРВАЯ ступень с 2026-09-10. Цена опущена с 16 000 по
 *     решению владельца: на коллекторах химзащиту не носил никто (0 из 1354),
 *     потому что ценовой потолок лута у тамошнего жильца ~4 400 ₽ и ОЗК давился
 *     множителем «не по карману». Вес против этого бессилен — замерено, 6 → 40
 *     не сдвинуло коллекторы вообще. При 11 000 стало 14 из 29 одетых, то есть
 *     примерно пополам с лёгкой; общее число одетых не изменилось.
 *     Порядок в лестнице сдвинут вместе с ценой: резиновый комплект дешевле
 *     стальной плиты, и это читается как ступень, а не как исключение;
