 ...
 * 28 → 29 → 30 → 31 (2026-09-09): караванные полосы, память режиссёра самосбора,
 * выбранная цель квеста. Полосы поставок (пошлины,
...
test('Demos persistent social batch owns the current save shape', () => {
  assert.equal(currentSaveShapeVersion(), 31);
});
