 ...
 *  ушли вместе с зачисткой Пустоты, а Инга Трубная — вместе с вырезанной
 *  пневмопочтой. Равенство, а не `<=`: девятая такая строка означает, что кто-то
...
const CONTENT_FLOOR = {
  // Пол опущен на одного человека и один контракт вместе с вырезанной
  // пневмопочтой (Инга Трубная, «Журнал из трубы»). Это единственный законный
  // повод его двигать вниз: снятая механика, а не потерянный модуль.
  packages: 467,
  plotSlots: 475,
  sideQuests: 430,
  contracts: 204,
