...
test('forpost defense musters its first wave on the live collectors floor', () => {
  for (const seed of SEEDS) {
    /* Только РАССТАНОВКА: она стоит одну генерацию и врёт первой, если сцена
     * посадила волну не туда.
     *
     * Проигрывание сцены снято целиком (решение владельца 2026-08-24): тест
     * смотрел кат-сцену в реальном времени — 170 игровых секунд по 60 кадров с
     * полным циклом AI, — и стоил больше минуты ради утверждений, которые
     * владелец всё равно проверяет глазами в живой сборке. Вместе с ним ушли
     * замки на вторую волну и на то, что сцена доигрывает: их цена не окупалась. */
