...
/**
 * Полная цена руки игрока: −2 жертве, −1 карма, −1 свидетелю. МАТРИЦА НУЛЬ.
 *
...
const PLAYER_HIT: Outcome =
  { hp: DAMAGE, victimRel: -2, karma: -1, matrix: 0, witnessRel: -1, threat: true };
...
const TABLE: Row[] = [
  ...
  { path: 'ко-оп-пир, ближний бой', attacker: 'пир', victim: 'игрок', expect: SILENT(DAMAGE, false) },
];
