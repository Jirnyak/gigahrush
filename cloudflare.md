...
- `functions/api/net/hello.ts` - heartbeat, онлайн, профиль НЕТ-ГЕН.
...
- Новый браузер получает НЕТ-ГЕН вида `NET-XXXX-XXXX-XXXX` и хранит его в `localStorage`.
